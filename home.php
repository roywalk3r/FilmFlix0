...
<form class="signup-form" id="regform" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
    ...
    <section class="home container" id="home">
      ...
      <div class="video-container">
        ...
        <div class="video-box">
          <video
            src="assets/play-page/KRAVEN THE HUNTER.mp4"
            controls
            id="myvideo"
          ></video>
...
<script>
      ...
      <div class="popular-content swiper">
        <div class="swiper-wrapper">
          ...
          <div class="swiper-slide">
            <div class="movie-box">
              <img
                src="assets/img/tomorrow_job.jpg"
                alt="spiderman"
                class="movie-box-img"
              />
              <div class="box-text">
          ...
          <div class="swiper-slide">
            <div class="movie-box">
              <img
                src="assets/img/no-hard-feelings.jpg"
                alt="jungle Cruise"
                class="movie-box-img"
              />
              <div class="box-text">
          ...
          <div class="swiper-slide">
            <div class="movie-box">
              <img
                src="assets/img/hitmen.jpg"
                alt="HitmansBodyguard"
                class="movie-box-img"
              />
              <div class="box-text">
          ...
          <div class="swiper-slide">
            <div class="movie-box">
              <img
                src="assets/img/spiderverse.jpg"
                alt="Across The Spiderverse"
                class="movie-box-img"
              />
              <div class="box-text">
          ...
          <div class="swiper-slide">
            <div class="movie-box">
              <img
                src="assets/img/insidius.jpg"
                alt="Insidious Red Door"
                class="movie-box-img"
              />
              <div class="box-text">
          ...
          <div class="swiper-slide">
            <div class="movie-box">
              <img
                src="assets/img/transformers.jpg"
                alt="extraction"
                class="movie-box-img"
              />
              <div class="box-text">
          ...
          <div class="swiper-slide">
            <div class="movie-box">
              <img
                src="assets/img/John_Wick_TeaserPoster.jpg"
                alt=""
                class="movie-box-img"
              />
              <div class="box-text">
      ...
      <div class="popular-content swiper">
        <div class="swiper-wrapper">
          ...
          <div class="swiper-slide">
            <div class="movie-box">
              <img
                src="assets/img/popular-movie-1.jpg"
                alt="spiderman"
                class="movie-box-img"
              />
              <div class="box-text">
          ...
          <div class="swiper-slide">
            <div class="movie-box">
              <img
                src="assets/img/popular-movie-2.jpg"
                alt="jungle Cruise"
                class="movie-box-img"
              />
              <div class="box-text">
          ...
          <div class="swiper-slide">
            <div class="movie-box">
              <img
                src="assets/img/Black_Panther_Wakanda_Forever_poster.jpg"
                alt="Black_Panther_Wakanda_Forever_poster"
                class="movie-box-img"
              />
              <div class="box-text">
          ...
          <div class="swiper-slide">
            <div class="movie-box">
              <img
                src="assets/img/HitmansBodyguard.jpg"
                alt="HitmansBodyguard"
                class="movie-box-img"
              />
              <div class="box-text">
          ...
          <div class="swiper-slide">
            <div class="movie-box">
              <img
                src="assets/img/gretel_hansel.jpg"
                alt="gretel_hansel"
                class="movie-box-img"
              />
              <div class="box-text">
          ...
          <div class="swiper-slide">
            <div class="movie-box">
              <img
                src="assets/img/extraction.jpeg"
                alt="extraction"
                class="movie-box-img"
              />
              <div class="box-text">
          ...
          <div class="swiper-slide">
            <div class="movie-box">
              <img
                src="assets/img/david_beckham.jpg"
                alt=""
                class="movie-box-img"
              />
              <div class="box-text">
    ...
    <section class="movies container" id="movies">
      ...
      <div class="movies-content">
        ...
        <div class="movie-box">
          <img
            src="assets/img/the-viking-war.jpg"
            alt=""
            class="movie-box-img"
          />
          <div class="box-text">
        ...
        <div class="movie-box">
          <img
            src="assets/img/crush-christmas.jpg"
            alt="Movie Image"
            class="movie-box-img"
          />
          <div class="box-text">
        ...
        <div class="movie-box">
          <img
            src="assets/img/far-from-home.jpg"
            alt=""
            class="movie-box-img"
          />
          <div class="box-text">
        ...
        <div class="movie-box">
          <img
            src="assets/img/Shanghai_Fortress_chinese_film_2018_poster.jpg"
            alt=""
            class="movie-box-img"
          />
          <div class="box-text">
      ...
      <div class="popular-content swiper">
        <div class="swiper-wrapper">
          ...
          <div class="swiper-slide">
            <div class="movie-box">
              <img
                src="assets/img/i-spit-grave-2.jpg"
                alt=""
                class="movie-box-img"
              />
              <div class="box-text">
          ...
          <div class="swiper-slide">
            <div class="movie-box">
              <img
                src="assets/img/wrong-turn-6.jpg"
                alt=""
                class="movie-box-img"
              />
              <div class="box-text">
          ...
          <div class="swiper-slide">
            <div class="movie-box">
              <img
                src="assets/img/the_punisher.jpg"
                alt=""
                class="movie-box-img"
              />
              <div class="box-text">
          ...
          <div class="swiper-slide">
            <div class="movie-box">
              <img
                src="assets/img/resident-evil.jpg"
                alt=""
                class="movie-box-img"
              />
              <div class="box-text">
      ...
      <div class="popular-content swiper">
        <div class="swiper-wrapper">
          ...
          <div class="swiper-slide">
            <div class="movie-box">
              <img
                src="assets/img/suicide_squad.jpg"
                alt=""
                class="movie-box-img"
              />
              <div class="box-text">
          ...
          <div class="swiper-slide">
            <div class="movie-box">
              <img
                src="assets/img/horriblebosses1.jpg"
                alt=""
                class="movie-box-img"
              />
              <div class="box-text">
          ...
          <div class="swiper-slide">
            <div class="movie-box">
              <img
                src="assets/img/horriblebosses.jpg"
                alt=""
                class="movie-box-img"
              />
              <div class="box-text">
          ...
          <div class="swiper-slide">
            <div class="movie-box">
              <img
                src="assets/img/ride-along-2.jpg"
                alt=""
                class="movie-box-img"
              />
              <div class="box-text">
