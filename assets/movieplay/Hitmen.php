...
<html lang="en-US">
  <head>
    ...
    <link
      rel="canonical"
      href="https://rseann.helioho.st/assets/movieplay/Hitmen.html"
    />
    <title>Watch: Hitmen (2023)</title>
    ...
    <div class="section-container body-container">
      <div class="main-left">
        <div class="movie-play">
          <img src="../img/hitmen-2023.jpg " alt="thumbnail" id="thumbnail" />
          <iframe
            src="https://vidsrc.to/embed/movie/522931"
            allowfullscreen
            allowtransparency
            allow="autoplay"
            scrolling="no"
        ...
        <div class="about-movie container">
          <div class="sypnosis">
            <img src="../img/hitmen.jpg" alt="movie poster" class="img" />
            <div class="content">
              <h2>HitMen</h2>
              <div class="req">
                <span><i class="bx bx-calendar-alt"></i> 2023</span>
                <span class="age-req"><i>PG 15</i></span>
                <span><i class="bx bx-time"></i> 1h 48min</span>
              </div>
              <p>
                Michael Hero, a powerful CEO, seeks vengeance for the murder of
                his grandson by offering a one-million-dollar bounty for the
                assassination of his grandson's accidental killers, attracting
                the world's leading assassins to the task at hand.
              </p>
              <span id="release"
              ...
              <span id="writer"
                >Writer <span id="name">: Savvas D. Michael</span></span
              >
          ...
          <div class="cast">
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/21315-eric-roberts?language=en-US"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/NiWg1TaUcal7xn1ZQeyA2dLd5F.jpg "
                  alt="Eric Roberts"
                  class="cast-img"
                />
              </a>
              <span class="cast-title">Eric Roberts</span>
            </div>
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/78064-adam-deacon?language=en-US"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src=" https://www.themoviedb.org/t/p/w300_and_h450_bestv2/sImOhX3cOaZLFikqO8TuBq1vePd.jpg"
                  alt="Adam Deacon"
                  class="cast-img"
                />
              </a>
              <span class="cast-title">Adam Deacon</span>
            </div>
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/74750-georges-st-pierre?language=en-US"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/1gRSxCOOf9jxJdGtYNi5FPoXS9l.jpg "
                  alt="Georges St-Pierre"
                  class="cast-img"
                />
              </a>
              <span class="cast-title">Georges St-Pierre</span>
            </div>
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/19875-daniel-caltagirone?language=en-US"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/2LUz4M9PVRxMePqJ74hP05Wdwi3.jpg "
                  alt="Daniel Caltagirone"
                  class="cast-img"
                />
              </a>
              <span class="cast-title">Daniel Caltagirone</span>
            </div>
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/2915667-lois-brabin-platt?language=en-US"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src=" https://www.themoviedb.org/t/p/w300_and_h450_bestv2/pZacnUmojiWUbzgwZ7CIXSu7B6i.jpg"
                  alt="Lois Brabin-Platt"
                  class="cast-img"
                />
              </a>
              <span class="cast-title">Lois Brabin-Platt</span>
            </div>
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/995-vas-blackwood?language=en-US"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/7xxlJe5O9SyPLH0tXIK7WLd2iB1.jpg "
                  alt="Vas Blackwood"
                  class="cast-img"
                />
              </a>
              <span class="cast-title">Vas Blackwood</span>
            </div>
          </div>
        </div>
        <!-- Download -->
        <div class="download">
          ...
          <div class="download-links">
            <a
              href="https://streamtape.com/v/GMZKvVb3jzh9Kw/Hitmen_%282023%29.mkv.mp4#"
              target="_blank"
              download
              >480p</a
            >
