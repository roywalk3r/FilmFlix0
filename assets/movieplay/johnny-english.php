...
<html lang="en-US">
  <head>
    ...
    <link
      rel="canonical"
      href="https://rseann.helioho.st/assets/movieplay/johnny-english.html"
    />
    <title>Watch: Johnny English Strikes Again (2018)</title>
    <!-- Local Links -->
    ...
    <div class="section-container body-container">
      <div class="main-left">
        <div class="movie-play">
          <img
            src="https://images.squarespace-cdn.com/content/v1/64639805a247a84851f6dbb1/1b48df98-7580-4e1d-a690-c5a25b1fd0c4/Johnny-English-3.jpg?format=1000w "
            alt="thumbnail"
            id="thumbnail"
          />
          <iframe
            src="https://vidsrc.to/embed/movie/tt6921996"
            allowfullscreen
            allowtransparency
            allow="autoplay"
            scrolling="no"
        ...
        <div class="about-movie container">
          <div class="sypnosis">
            <img src="../img/movie-8.jpg" alt="movie poster" class="img" />
            <div class="content">
              <h2>Johnny English Strikes Again</h2>
              <div class="req">
              ...
              <p>
                Disaster strikes when a criminal mastermind reveals the
                identities of all active undercover agents in Britain. The
                secret service can now rely on only one man - Johnny English.
                Currently teaching at a minor prep school, Johnny springs back
                into action to find the mysterious hacker. For this mission to
                succeed, he’ll need all of his skills - what few he has - as the
                man with yesterday’s analogue methods faces off against
                tomorrow’s digital technology.
              </p>
              <span id="release"
                ><i class="fa fa-calendar"></i> Release date : 5<sup>th</sup>
                September 2018</span
              >
              <span id="writer"
                >Writer <span id="name">: Wiliam Davies</span></span
              >
          ...
          <div class="cast">
            <div class="cast-box">
              <img
                src="https://upload.wikimedia.org/wikipedia/commons/thumb/b/b3/Rowan_Atkinson_2011_2_cropped.jpg/800px-Rowan_Atkinson_2011_2_cropped.jpg "
                alt="Rowan Atkinson"
                class="cast-img"
              />
              <span class="cast-title">Rowan Atkinson</span>
            </div>
            <div class="cast-box">
              <img
                src="https://upload.wikimedia.org/wikipedia/commons/thumb/4/49/Festival_de_Cinema_de_Sitges_2019_%2849500414408%29_%28cropped%29.jpg/220px-Festival_de_Cinema_de_Sitges_2019_%2849500414408%29_%28cropped%29.jpg "
                alt="Olga Kurylenko"
                class="cast-img"
              />
              <span class="cast-title">Olga Kurylenko</span>
            </div>
            <div class="cast-box">
              <img
                src=" https://upload.wikimedia.org/wikipedia/commons/thumb/a/a0/Emma_Thompson_2022.jpg/220px-Emma_Thompson_2022.jpg"
                alt="Emma Thompson"
                class="cast-img"
              />
            ...
            <div class="cast-box">
              <img
                src="https://upload.wikimedia.org/wikipedia/commons/thumb/6/6a/Jake_Lacy_at_TCA_2010.jpg/220px-Jake_Lacy_at_TCA_2010.jpg "
                alt="Jake Lacy"
                class="cast-img"
              />
              <span class="cast-title">Jake Lacy</span>
            </div>
            <div class="cast-box">
              <img
                src="https://upload.wikimedia.org/wikipedia/commons/thumb/3/3a/Ben_Miller_20191205.jpg/800px-Ben_Miller_20191205.jpg "
                alt="Ben Miller"
                class="cast-img"
              />
              <span class="cast-title">Ben Miller</span>
            </div>
            <div class="cast-box">
              <img
                src="https://upload.wikimedia.org/wikipedia/commons/b/b0/Kevin_Eldon_2013.jpg "
                alt="Kevin Edon"
                class="cast-img"
              />
              <span class="cast-title">Kevin Edon</span>
            </div>
          </div>
        </div>
        <!-- Download -->
        <div class="download">
          ...
          <div class="download-links">
            <a
              href="https://streamtape.com/v/bGx22YyXJxCPzdx/Johnny_English_Strikes_Again_%282018%29_BluRay_720p_%28fzmovies.net%29_c45410c7403ad633175a42acce9ca8f5.mkv#"
              target="_blank"
              download
              >480p</a
            >
      ...
      <div class="right-sidebar">
        ...
        <div class="related-movies">
          ...
          <a href="iron-mask.html">
            <div class="movie">
              <img src="../img/iron-mask.jpg" alt="" />
              <div class="movie-container">
                <small>Action</small>
                <h4>Iron Mask 2</h4>
                <span class="bottom-content">
          ...
          <a href="">
            <div class="movie">
              <img src="../img/popular-movie-2.jpg" alt="" />
              <div class="movie-container">
                <small>Mystry</small>
                <h4>Jungle Cruise</h4>
                <span class="bottom-content">
