...
<html lang="en-US">
  <head>
    ...
    />
    <title>Watch: No Hard Feelings (2023)</title>
    ...
    <link
      rel="stylesheet"
      href="assets/fontawesome-free-6.4.0-web/css/fontawesome.min.css"
    />
    <link
      rel="stylesheet"
    ...
    <div class="section-container body-container">
      <div class="main-left">
        <div class="movie-play">
          <img
            src="https://www.themoviedb.org/t/p/original/rRcNmiH55Tz0ugUsDUGmj8Bsa4V.jpg"
            alt="thumbnail"
            id="thumbnail"
          />
          <iframe
        ...
        <div class="about-movie container">
          <div class="sypnosis">
            ...
            <div class="content">
              ...
              <p>
                On the brink of losing her childhood home, Maddie discovers an
                intriguing job listing: wealthy helicopter parents looking for
                someone to “date” their introverted 19-year-old son, Percy,
                before he leaves for college. To her surprise, Maddie soon
                discovers the awkward Percy is no sure thing.
              </p>
              <span id="release"
          ...
          <div class="cast">
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/72129-jennifer-lawrence?language=en-US"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/mDKMsjOMytyBiy7MHNZTa7gp7wj.jpg"
                  alt="Jennifer Lawrence"
                  class="cast-img"
                />
              </a>
              <span class="cast-title">Jennifer Lawrence</span>
            </div>
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/2914688-andrew-barth-feldman?language=en-US"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/17rLE4Q4gKejJp1TsByGnzMpK00.jpg "
                  alt="Andrew Barth Feldman"
                  class="cast-img"
                />
              </a>
              <span class="cast-title">Andrew Barth Feldman</span>
            </div>
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/60034-laura-benanti?language=en-US"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/meoraoVzlCExK6RUFX2GqVNv0vw.jpg "
                  alt="Laura Benanti"
                  class="cast-img"
                />
              </a>
              <span class="cast-title">Laura Benanti</span>
            </div>
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/4756-matthew-broderick?language=en-US"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/2Pq8pwOX5ZFfT2p5pNLGfvUi9Pp.jpg"
                  alt="Matthew Broderick"
                  class="cast-img"
                />
              </a>
              <span class="cast-title">Matthew Broderick</span>
            </div>
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/118752-natalie-morales?language=en-US"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/faHjkHWepBM2mx8lq7kS0D3YeOE.jpg "
                  alt="Natalie Morales"
                  class="cast-img"
                />
              </a>
              <span class="cast-title">Natalie Morales</span>
            </div>
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/209087-scott-macarthur?language=en-US"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/A5jWdGFfH657oaC92tch7e3WGHs.jpg "
                  alt="Scott MacArthur"
                  class="cast-img"
                />
              </a>
              <span class="cast-title">Scott MacArthur</span>
            </div>
          </div>
        </div>
        <!-- Download -->
        <div class="download">
          ...
          <div class="download-links">
            <a
              href="https://streamtape.com/v/xmMdwlBjY0TkkgW/No_Hard_Feelings_%282023%29.mkv.mp4#"
              target="_blank"
              download
              >480p</a
            >
        ...
        <div class="swiper mySwiper">
          <div class="swiper-wrapper">
            <div class="swiper-slide">
              <img src="../img/little.jpg" alt="" />
              <div class="box-text">
                <a href="../movieplay/little.html" class="watch-btn play-btn">
                  <i class="bx bx-right-arrow"></i>
                </a>
              </div>
            </div>
            <div class="swiper-slide">
              <img src="../img/horriblebosses1.jpg" alt="" />
              <div class="box-text">
                <a
                  href="../movieplay/horriblebosses1.html"
