...
<html lang="en-US">
  <head>
    ...
    <link
      rel="canonical"
      href="https://rseann.helioho.st/assets/movieplay/the-viking-warhtml"
    />
    <title>Watch: The Viking War (2019)</title>
    <!-- Local Links -->
    ...
    <div class="section-container body-container">
      <div class="main-left">
        <div class="movie-play">
          <img
            src="https://www.themoviedb.org/t/p/original/bTkKoTEm7KgdpEhaxVG4HQkLO9a.jpg"
            alt="thumbnail"
            id="thumbnail"
          />
          <iframe
            src="https://vidsrc.to/embed/movie/584044"
            allowfullscreen
            allowtransparency
            allow="autoplay"
            scrolling="no"
        ...
        <div class="about-movie container">
          <div class="sypnosis">
            <img
              src="../img/the-viking-war.jpg"
              alt="movie poster"
              class="img"
            />
            <div class="content">
              <h2>The Viking War</h2>
              <div class="req">
              ...
              >
              <span id="writer"
                >Writer <span id="name">: Suzy Spade</span></span
              >
          ...
          <div class="cast">
            <div class="cast-box">
              <img
                src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/iEK7JPQO7zInneVKmCZlXD0E8Ai.jpg "
                alt="Darcie Lincoln"
                class="cast-img"
              />
              <span class="cast-title">Darcie Lincoln</span>
            </div>
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/1585056-peter-cosgrove"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/cpxNZOimBlK963tZ7ya6yW97Pj4.jpg "
                  alt="Peter Cosgrove"
                  class="cast-img"
              /></a>
              <span class="cast-title">Peter Cosgrove</span>
            </div>
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/2248341-victor-toth"
                target="_blank"
                title="read about actor on MovieDB"
                ><img
                  src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/1YK2yxATzk2UAwuzrDqwWdHAhbc.jpg "
                  alt="Victor Toth"
                  class="cast-img"
              /></a>
              <span class="cast-title">Victor Toth</span>
            </div>

            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/1908402-michelle-archer"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/fMxea88UvBulStQecgpthZMoRpM.jpg "
                  alt="Michelle Archer"
                  class="cast-img"
                />
              </a>
              <span class="cast-title">Michelle Archer</span>
            </div>
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/2248346-shaila-alvarez"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src=" https://www.themoviedb.org/t/p/w300_and_h450_bestv2/9auvYMdDW1fPuhff2n9JbGPNYOw.jpg"
                  alt="Shaila Alvarez0"
                  class="cast-img"
                />
              </a>
              <span class="cast-title">Shaila Alvarez </span>
            </div>
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/2241577-jerry-anton"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/ms5qJxKF12vEYkiladbojpi1kyV.jpg "
                  alt="Jerry Anton"
                  class="cast-img"
                />
              </a>
              <span class="cast-title">Jerry Anton</span>
            </div>
          </div>
        </div>
        <!-- Download -->
        <div class="download">
          ...
          <div class="download-links">
            <a
              href="https://streamtape.com/v/dq9MxbkjPpskaml/%5BWaploaded%5D_the-viking-war-2019.mp4#"
              target="_blank"
              download
              >480p</a
            >
