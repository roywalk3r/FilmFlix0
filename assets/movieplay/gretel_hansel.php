...
<html lang="en-US">
  <head>
    ...
    />
    <title>Watch: Gretel And Hansel (2020)</title>
    <!-- Local Links -->
...
<form class="signup-form" id="regform" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
       ...
       <div class="section-container body-container">
        <div class="main-left">
          <div class="movie-play">
            <img
              src="../img/gretel_hansel(20).jpg"
              alt="thumbnail"
              id="thumbnail"
            />
            <iframe
              src="https://vidsrc.to/embed/movie/tt9086228"
              allowfullscreen
              allowtransparency
              allow="autoplay"
              scrolling="no"
    ...
    <div class="about-movie container">
      <div class="sypnosis">
        <img src="../img/gretel_hansel.jpg" alt="movie poster" class="img" />
        <div class="content">
          <h2>Gretel & Hansel</h2>
          <div class="req">
          ...
          <p>
            The film follows the story of two siblings, Gretel and Hansel, who
            are abandoned in the woods by their parents. They find themselves in
            a dark and dangerous forest, where they must face the evil witch
            Holda.
          </p>
          <span id="release"
            ...
            January 2020</span
          >
          <span id="writer">Writer <span id="name">: Rob Hays</span></span>
      ...
      <div class="cast">
        <div class="cast-box">
          <img
            src="https://upload.wikimedia.org/wikipedia/commons/8/8c/Sophia_lillis_nancy_drew_2019_2.png"
            alt=""
            class="Sofia Lillis"
          />
          <span class="cast-title">Sophia Lillis</span>
        </div>
        <div class="cast-box">
          <img
            src="https://m.media-amazon.com/images/M/MV5BNTc4NTJmOGEtNTAzNC00M2U4LTkzMDUtNjJmYzc2YTY0ODU4XkEyXkFqcGdeQXVyODg1MDg2NTY@._V1_.jpg"
            alt=""
            class="Samuel Leakey"
          />
          <span class="cast-title">Samuel Leakey </span>
        </div>
        <div class="cast-box">
          <img
            src="https://flxt.tmsimg.com/assets/3685_v9_bb.jpg"
            alt=""
            class="Alice Krige"
          />
          <span class="cast-title">Alice Krige</span>
        </div>
        <div class="cast-box">
          <img
            src="https://m.media-amazon.com/images/M/MV5BMTY0MzY0MDM5N15BMl5BanBnXkFtZTgwOTI4Njk4MTE@._V1_.jpg"
            alt="Jessica De Gouw"
            class="cast-img"
          />
          <span class="cast-title"> Jessica De Gouw</span>
        </div>
        <div class="cast-box">
          <img
            src="https://ntvb.tmsimg.com/assets/assets/283466_v9_bb.jpg"
            alt="Michiel Huisman"
            class="cast-img"
          />
          <span class="cast-title">Michiel Huisman</span>
        </div>
        <div class="cast-box">
          <img
            src="https://i.pinimg.com/736x/b4/12/14/b412140066405799717c60404c8aec0c--elijah-wood-famous-men.jpg"
            alt=""
            class="ELijah Wood"
          />
          <span class="cast-title">Elijah Wood</span>
        </div>
      </div>
    </div>
           <!-- Download -->
    <div class="download">
      ...
      <div class="download-links">
        <a
          href="https://streamtape.com/v/RAB11xpabOfdOOx/%5BWaploaded_1%5DGretel_And_Hansel_2020.mp4#"
          target="_blank"
          download
          >480p</a
        >
