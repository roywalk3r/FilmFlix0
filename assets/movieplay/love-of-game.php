...
<html lang="en-US">
  <head>
    ...
    <link
      rel="canonical"
      href="https://rseann.helioho.st/assets/movieplay/love-of-game.html"
    />
    <title>Watch: David.Beckham.For.The.Love.Of.The.Game.2015</title>
    <!-- Local Links -->
    ...
    <div class="section-container body-container">
      <div class="main-left">
        <div class="movie-play">
          <img
            src="https://streamcoimg-a.akamaihd.net/000/332/4611/3324611-BoxArt-c5850cca723b8e299b9051131a12d15b.jpg"
            alt="thumbnail"
            id="thumbnail"
          />
          <iframe
            src="https://vidsrc.to/embed/movie/tt5257656"
            allowfullscreen
            allowtransparency
            allow="autoplay"
            scrolling="no"
        ...
        <div class="about-movie container">
          <div class="sypnosis">
            <img
              src="../img/david_beckham.jpg"
              alt="movie poster"
              class="img"
            />
            <div class="content">
              <h2>David Beckham For The Love Of The Game</h2>
              <div class="req">
                <span><i class="bx bx-calendar-alt"></i> 2015</span>
                <span class="age-req"><i>+</i></span>
                <span><i class="bx bx-time"></i> 1h 27min</span>
              </div>
              <p>
                The film ends with David Beckham retiring from soccer at the age
                of 38. He has won numerous trophies, including the World Cup,
                the European Championship, and the Champions League. He is
                considered one of the greatest soccer players of all time.
              </p>
              <span id="release"
                ><i class="fa fa-calendar"></i> Release date : 28<sup>th</sup>
                December 2015</span
              >
              <span id="writer"
                >Writer <span id="name">: Matt Smith</span></span
              >
              <div class="rating-card">
                <div class="rating-content">
                  <h2 class="card-heading">7.81/10</h2>
                  <span style="color: rgb(86, 39, 129)">9314 reviews</span>
                </div>
                <div class="stars">
          ...
          <div class="cast">
            <div class="cast-box">
              <img
                src="https://www.azcentral.com/gcdn/-mm-/07be187aa5f32b6251857e88beb930e1f28756f6/c=104-0-592-650/local/-/media/Phoenix/2015/04/06/e28e8f8d746f5ba6be0f67edcafdadee38307739.jpg?width=300&height=400&fit=crop&format=pjpg&auto=webp"
                alt="David Beckham"
                class="David Beckham"
              />
              <span class="cast-title">David Beckham</span>
            </div>
            <div class="cast-box">
              <img
                src="https://www.shutterstock.com/image-photo/ray-winstone-los-angeles-premiere-600w-94685392.jpg"
                alt="Ray Winstone"
                class="Ray Winstone"
              />
              <span class="cast-title">Ray Winstone</span>
            </div>
            <div class="cast-box">
              <img
                src="https://editorial01.shutterstock.com/wm-preview-1500/4587782n/ccb07a0c/Shutterstock_4587782n.jpg"
                alt="Samantha Morton"
                class="Samantha Morton"
              />
              <span class="cast-title">Samantha Morton</span>
            </div>
          </div>
        </div>
        <!-- Download -->
        <div class="download">
          ...
          <div class="download-links">
            <a
              href="https://streamtape.com/v/JkBJpRW963tjKPw/David.Beckham.For.The.Love.Of.The.Game.2015.DVDRip.Ganool.ph.mkv.mp4#"
              target="_blank"
              download
              >480p</a
            >
