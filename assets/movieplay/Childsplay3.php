...
<html lang="en-US">
  <head>
    ...
    />
    <title>Watch: Child's Play (1991)</title>
    <!-- Local Links -->
    ...
    <div class="section-container body-container">
      <div class="main-left">
        <div class="movie-play">
          <img
            src=" https://wallpapers.com/images/hd/child-s-play-3-movie-poster-h0m66kowpr44bsvi.jpg"
            alt="thumbnail"
            id="thumbnail"
          />
          <iframe
            src="https://vidsrc.to/embed/movie/tt0103956"
            allowfullscreen
            allowtransparency
            allow="autoplay"
            scrolling="no"
        ...
        <div class="about-movie container">
          <div class="sypnosis">
            <img src="../img/childsplay.jpg" alt="" class="img" />
            <div class="content">
              <h2>Child's Play</h2>
              <div class="req">
                <span><i class="bx bx-calendar-alt"></i> 1991</span>
                <span class="age-req"><i>18+</i></span>
                <span><i class="bx bx-time"></i> 1h 30min</span>
              </div>
              <p>
                Eight years have passed since the events of the second film.
                Chucky has been resurrected once again and seeks revenge on
                Andy, his former owner, who is now a teenager enrolled in
                military school.
              </p>
              <span id="release"
                ><i class="fa fa-calendar"></i> Release date : 30<sup>th</sup>
                July 1991</span
              >
              <span id="writer"
              ...
              <div class="rating-card">
                <div class="rating-content">
                  ...
                  <span style="color: rgb(86, 39, 129)">4214 reviews</span>
                </div>
                <div class="stars">
          ...
          <div class="cast">
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/68494-justin-whalin"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/oEKsEJsmAj1ozJ2ehZ60NeJvfW0.jpg "
                  alt="Justin Whalin"
                  class="cast-img"
                />
              </a>
              <span class="cast-title">Justin Whalin</span>
            </div>
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/68495-perrey-reeves"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src=" https://www.themoviedb.org/t/p/w300_and_h450_bestv2/xgsCxH6GbrAj4JGrVk89hH7aOdW.jpg"
                  alt="Perrey Reeves"
                  class="cast-img"
                />
              </a>
              <span class="cast-title">Perrey Reeves</span>
            </div>
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/68496-jeremy-sylvers"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/dnHX6Dcm7SzzDj5R4W8JIQWE00c.jpg"
                  alt="Jeremy Sylvers"
                  class="cast-img"
                />
              </a>
              <span class="cast-title">Jeremy Sylvers</span>
            </div>
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/32802-travis-fine"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/4gjRxvndiZllcCsdpNQr5I0mfY2.jpg "
                  alt="Travis Fine"
                  class="cast-img"
                />
              </a>
              <span class="cast-title">Travis Fine</span>
            </div>
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/68497-dean-jacobson"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/wkgTixkDkyRrNbBFkXfciBDNKYQ.jpg "
                  alt="Dean Jacobson"
                  class="cast-img"
                />
              </a>
              <span class="cast-title">Dean Jacobson</span>
            </div>
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/z2LYR7Ickql7g5hnWJSIAWMPD4o.jpg"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/z2LYR7Ickql7g5hnWJSIAWMPD4o.jpg "
                  alt="Brad Dourif"
                  class="cast-img"
                />
              </a>
              <span class="cast-title">Brad Dourif</span>
            </div>
          </div>
        </div>
        <!-- Download -->
        <div class="download">
          ...
          <div class="download-links">
            <a
              href="https://streamtape.com/v/yAbwBKaDaXc1RZr/Childs_Play_3_-_Look_Whos_Stalking_%281991%29_BluRay_v2_720p_%28fzmovies.net%29_2b9dafb363713a5ffac2b4414f66922c.mkv.mp4#"
              target="_blank"
              download
              >480p</a
            >
