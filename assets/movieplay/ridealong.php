...
<html lang="en-US">
  <head>
    ...
    <link
      rel="canonical"
      href="https://rseann.helioho.st/assets/movieplay/ridealong.html"
    />
    <title>Watch:</title>
    ...
    <div class="section-container body-container">
      <div class="main-left">
        <div class="movie-play">
          <img
            src="../img/ride-along-2-poster.jpg"
            alt="thumbnail"
            id="thumbnail"
          />
          <iframe
            src="https://vidsrc.to/embed/movie/tt2869728"
            allowfullscreen
            allowtransparency
            allow="autoplay"
            scrolling="no"
        ...
        <div class="about-movie container">
          <div class="sypnosis">
            <img src="../img/ride-along-2.jpg" alt="movie poster" class="img" />
            <div class="content">
              <h2>Ride Along 2</h2>
              <div class="req">
                <span><i class="bx bx-calendar-alt"></i> 2015</span>
                <span class="age-req"><i>PG-13</i></span>
                <span><i class="bx bx-time"></i> 1h 42min</span>
              </div>
              <p>
                As his wedding day approaches, Ben heads to Miami with his
                soon-to-be brother-in-law James to bring down a drug dealer
                who's supplying the dealers of Atlanta with product.
              </p>
              <span id="release"
                ><i class="fa fa-calendar"></i> Release date : 15<sup>th</sup>
                January 2015
              </span>
              <span id="writer">Writer <span id="name">:Phil Hay </span></span>
          ...
          <div class="download">
            ...
            <div class="download-links">
              <a
                href="https://streamtape.com/v/KqkWwe6gYlH0rvA/Ride_Along_%282014%29.mkv.mp4#"
                target="_blank"
                download
                >480p</a
              >
        ...
        <div class="cast">
          <div class="cast-box">
            <a
              href="https://www.themoviedb.org/person/55638-kevin-hart?language=en-US"
              target="_blank"
              title="read about actor on MovieDB"
            >
              <img
                src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/7OwsFfoxNGIfWwSmdORyB7v8XNj.jpg "
                alt="Kevin Hart"
                class="cast-img"
              />
            </a>
          ...
          <div class="cast-box">
            <a
              href="https://www.themoviedb.org/person/9778-ice-cube?language=en-US"
              target="_blank"
              title="read about actor on MovieDB"
            >
              <img
                src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/ymR7Yll7HjL6i6Z3pt435hYi91T.jpg "
                alt="Ice Cube"
                class="cast-img"
              />
            </a>
            <span class="cast-title">Ice Cube</span>
          </div>
          <div class="cast-box">
            <a
              href="https://www.themoviedb.org/person/81364-olivia-munn?language=en-US"
              target="_blank"
              title="read about actor on MovieDB"
            >
              <img
                src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/ha4W3WfxBopQK2FZmVochNrN1GT.jpg "
                alt="Olivia Munn"
                class="cast-img"
              />
            </a>
            <span class="cast-title">Olivia Munn</span>
          </div>
          <div class="cast-box">
            <a
              href="https://www.themoviedb.org/person/110742-tika-sumpter?language=en-US"
              target="_blank"
              title="read about actor on MovieDB"
            >
              <img
                src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/1zTXufyuQFPXVthryH7KVoZAfb7.jpg "
                alt="Tika Sumpter"
                class="cast-img"
              />
            </a>
            <span class="cast-title">Tika Sumpter</span>
          </div>
          <div class="cast-box">
            <a
              href="https://www.themoviedb.org/person/83586-ken-jeong?language=en-US"
              target="_blank"
              title="read about actor on MovieDB"
            >
              <img
                src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/9OAUwY25yPxItnkcnnJdtpNwMSp.jpg "
                alt="Ken Jeon"
                class="cast-img"
              />
            </a>
            <span class="cast-title">Ken Jeon</span>
          </div>
          <div class="cast-box">
            <a
              href="https://www.themoviedb.org/person/8169-tyrese-gibson?language=en-US"
              target="_blank"
              title="read about actor on MovieDB"
            >
              <img
                src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/1K315wBQBvDBuZMlzoozuGsqFXZ.jpg"
                alt="Tyrese Gibson"
                class="cast-img"
              />
            </a>
            <span class="cast-title">Tyrese Gibson</span>
          </div>
        </div>
      </div>
