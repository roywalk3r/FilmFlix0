...
<html lang="en-US">
  <head>
    ...
    <title>Watch: Spider-Man: Across the Spider-Verse (2023)</title>
    ...
    <div class="section-container body-container">
      <div class="main-left">
        <div class="movie-play">
          <img
            src="../img/spiderverseposter.jpg"
            alt="thumbnail"
            id="thumbnail"
          />
          <iframe
            src="https://vidsrc.to/embed/movie/tt9362722"
            allowfullscreen
            allowtransparency
            allow="autoplay"
            scrolling="no"
        ...
        <div class="about-movie container">
          <div class="sypnosis">
            <img src="../img/spiderverse.jpg" alt="movie poster" class="img" />
            <div class="content">
              ...
              <p>
                ...
                where he encounters the Spider Society, a team of Spider-People
                charged with protecting the Multiverse’s very existence. But
                when the heroes clash on how to handle a new threat, Miles finds
                himself pitted against the other Spiders and must set out on his
                own to save those he loves most.
              </p>
              <span id="release"
                ><i class="fa fa-calendar"></i> Release date : 2<sup>nd</sup>
                June 2023</span
              >
              <span id="writer">Writer <span id="name">:Phil Lord </span></span>
          ...
          <div class="cast">
            <div class="cast-box">
              ...
              <a
                href="https://www.themoviedb.org/person/587506-shameik-moore?language=en-US"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/uJNaSTsfBOvtFWsPP23zNthknsB.jpg "
                  alt="Shameik Moore"
                  class="cast-img"
                />
              </a>
              <span class="cast-title">Shameik Moore</span>
            </div>
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/130640-hailee-steinfeld?language=en-US"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src=" https://www.themoviedb.org/t/p/w300_and_h450_bestv2/q4UpZMEuvNCN5lL5L6xa3ICpheJ.jpg"
                  alt="Hailee Steinfeld"
                  class="cast-img"
                />
              </a>
              <span class="cast-title">Hailee Steinfeld</span>
            </div>
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/17881-jason-schwartzman?language=en-US"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src=" https://www.themoviedb.org/t/p/w300_and_h450_bestv2/gCjMdmW1DiPAClHVl4zHEIffIsE.jpg"
                  alt="Jason Schwartzman"
                  class="cast-img"
                />
              </a>
              <span class="cast-title">Jason Schwartzman</span>
            </div>
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/25072-oscar-isaac?language=en-US"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/dW5U5yrIIPmMjRThR9KT2xH6nTz.jpg "
                  alt="Oscar Isaac"
                  class="cast-img"
                />
              </a>
            ...
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/226366-brian-tyree-henry?language=en-US"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src=" https://www.themoviedb.org/t/p/w300_and_h450_bestv2/1UgDnFt3OteCJQPiUelWzIR5bvT.jpg"
            ...
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/141610-luna-lauren-velez?language=en-US"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src=" https://www.themoviedb.org/t/p/w300_and_h450_bestv2/98BvmTJCZHx0jPv0oNcv04Jkmfb.jpg"
                  alt=""
                  class="cast-img"
                />
              </a>
              <span class="cast-title">Luna Lauren Velez</span>
            </div>
          </div>
        </div>
        <!-- Download -->
        <div class="download">
          ...
          <div class="download-links">
            <a
              href="https://streamtape.com/v/7RAkVP8bg0IADq1/Spider_Man_Across_the_Spider_Verse_%282023%29.mkv.mp4#"
              target="_blank"
              download
              >480p</a
            >
      ...
      <div class="right-sidebar">
        ...
        <div class="related-movies">
          <a href="spiderman.html">
            <div class="movie">
              <img src="../img/Spiderman-noWayHome.png" alt="" />
