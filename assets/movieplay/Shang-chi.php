...
<html lang="en-US">
  <head>
    ...
    <link
      rel="canonical"
      href="https://rseann.helioho.st/assets/movieplay/Shang-chi.html"
    />
    <title>Watch : Shang-Chi And The Legend Of Ten Rings</title>
    <!-- Local Links -->
    ...
    <div class="section-container body-container">
      <div class="main-left">
        <div class="movie-play">
          <img
            src="https://www.themoviedb.org/t/p/original/r7K6Xt0RX4Mw0cAbZVw5cyb1Tux.jpg"
            alt="thumbnail"
            id="thumbnail"
          />
          <iframe
            src="https://vidsrc.to/embed/movie/566525"
            allowfullscreen
            allowtransparency
            allow="autoplay"
            scrolling="no"
        ...
        <div class="about-movie container">
          <div class="sypnosis">
            <img src="../img/movie-3.jpg" alt="movie poster" class="img" />
            <div class="content">
              <h2>Shang-Chi: And The Legend</h2>
              <div class="req">
                <span><i class="bx bx-calendar-alt"></i> 2021</span>
                <span class="age-req"><i>PG 13</i></span>
                <span><i class="bx bx-time"></i> 2h 12min</span>
              </div>
              <p>
              ...
              <span id="release"
                ><i class="fa fa-calendar"></i> Release date : 21<sup>th</sup>
                September 2021</span
              >
              <span id="writer"
                >Writer <span id="name">: Destin Daniel Cretton</span></span
              >
          ...
          <div class="cast">
            <div class="cast-box">
              <img
                src="https://upload.wikimedia.org/wikipedia/commons/thumb/b/bf/Simu_Liu_by_Gage_Skidmore.jpg/800px-Simu_Liu_by_Gage_Skidmore.jpg"
                alt="Simu Liu"
                class="cast-img"
              />
            ...
            <div class="cast-box">
              <img
                src="https://upload.wikimedia.org/wikipedia/commons/thumb/b/bd/Destin_Daniel_Cretton_by_Gage_Skidmore.jpg/800px-Destin_Daniel_Cretton_by_Gage_Skidmore.jpg"
                alt="Destin Daniel Cretton"
                class="cast-img"
              />
              <span class="cast-title">Destin Daniel Cretton</span>
            </div>
            <div class="cast-box">
              <img
                src="https://upload.wikimedia.org/wikipedia/commons/thumb/b/ba/Awkwafina%2C_2018_%28cropped%29.jpg/800px-Awkwafina%2C_2018_%28cropped%29.jpg"
                alt="Awkwafina"
                class="cast-img"
              />
            ...
            <div class="cast-box">
              <img
                src="https://upload.wikimedia.org/wikipedia/commons/f/f9/Menger_Zhang_2021_%28cropped%29.jpg"
                alt="Meng'er Zhang"
                class="cast-img"
              />
            ...
            <div class="cast-box">
              <img
                src="https://upload.wikimedia.org/wikipedia/commons/thumb/6/61/Fala_Chen_Event_Photo.jpg/800px-Fala_Chen_Event_Photo.jpg"
                alt="Fala Chen"
                class="cast-img"
              />
              <span class="cast-title">Fala Chen</span>
            </div>
            <div class="cast-box">
              <img
                src="https://upload.wikimedia.org/wikipedia/commons/thumb/a/a0/Benedict_Wong_%2828352087500%29_%28cropped%29.jpg/800px-Benedict_Wong_%2828352087500%29_%28cropped%29.jpg"
                alt="Benedict Wong"
                class="cast-img"
              />
        ...
        <div class="download">
          ...
          <div class="download-links">
            <a
              href="https://streamtape.com/v/aV1YkVdebqcxGm9/%5BWaploaded_880%5DShang-Chi_and_the_Legend_of_the_Ten_Rings_2021.mp4#"
              download
              >480p</a
            >
            <a
      ...
      <div class="right-sidebar">
        ...
        <div class="related-movies">
          <a href="shanghai-fortress.html">
            <div class="movie">
              <img
                src="../img/Shanghai_Fortress_chinese_film_2018_poster.jpg"
                alt=""
              />
              <div class="movie-container">
                <small>Fantasy</small>
                <h4>Shangai Fortress</h4>
