...
<head>
  ...
  <link rel="canonical" href="https://rseann.helioho.st/assets/movieplay/jumanji.html" />
    <title>Watch : Jumanji-Welcome To The Jungle</title>
    <!-- Local Links -->
 ...
 <div class="section-container body-container">
  <div class="main-left">
    <div class="movie-play">
      <img
        src="../play-page/play-background.jpg"
        alt="thumbnail"
        id="thumbnail"
      />
      <iframe
        src="https://vidsrc.to/embed/movie/tt2283362"
        allowfullscreen
        allowtransparency
        allow="autoplay"
        scrolling="no"
...
<div class="about-movie container">
    ...
    <div class="sypnosis">
      <img src="../img/movie-1.jpg" alt="movie poster" class="img">
      <div class="content">
        <h2>Jumanji: Welcome To the Jungle</h2>
        <div class="req">
      <span><i class="bx bx-calendar-alt"></i> 2020</span>
      <span class="age-req"><i>PG 13</i></span>
      <span><i class="bx bx-time"></i> 1h 59min</span>
      </div>
      ...
      <span  id="release"><i class="fa fa-calendar"></i> Release date : 20<sup>th</sup> December 2020</span>
      <span id="writer">Writer <span id="name">: Jake Kasdan</span></span>
    ...
    <div class="cast">
        <div class="cast-box">
            ...
            <span class="cast-title">Dwanyne Johnson</span>
        </div>
        <div class="cast-box">
        ...
        <div class="cast-box">
            ...
            <span class="cast-title">Nadison Iseman</span>
        </div>
    </div>
</div>
<!-- Download -->
<div class="download">
  ...
  <div class="download-links">
      <a href="https://streamtape.com/v/O7o0vVP4WDTZBYj/Jumanji_Welcome_to_the_Jungle_%282017%29_%28NetNaija.com%29.mp4#
" target="_blank" download="Jumanji">480p</a>
      <a href="https://streamtape.com/v/O7o0vVP4WDTZBYj/Jumanji_Welcome_to_the_Jungle_%282017%29_%28NetNaija.com%29.mp4#
" target="_blank" download>720p</a>
      <a href="https://streamtape.com/v/O7o0vVP4WDTZBYj/Jumanji_Welcome_to_the_Jungle_%282017%29_%28NetNaija.com%29.mp4#
" target="_blank" download>1080p</a>
  </div>
</div>
  </div>
...
<div class="swiper mySwiper">
    <div class="swiper-wrapper">
      <div class="swiper-slide"><img src="../img/spiderverse.jpg" alt="">
        <div class="box-text">
            <a href="../movieplay/acrosstheverse.html" class="watch-btn play-btn">
                <i class="bx bx-right-arrow"></i>
            </a>
        </div>
    </div>
      <div class="swiper-slide"><img src="../img/tomorrow_job.jpg" alt="">
        <div class="box-text">
      ...
      <div class="swiper-slide"><img src="../img/no-hard-feelings.jpg" alt="">
        <div class="box-text">
      ...
      <div class="swiper-slide"><img src="../img/horriblebosses.jpg" alt="">
        <div class="box-text">
      ...
      <div class="swiper-slide"><img src="../img/specter.jpg" alt="">
        <div class="box-text">
      ...
      <div class="swiper-slide"><img src="../img/little.jpg" alt="">
        <div class="box-text">
      ...
      <div class="swiper-slide"><img src="../img/deadpool.jpg" alt="">
        <div class="box-text">
            <a href="../movieplay/Deadpool.html" class="watch-btn play-btn">
                <i class="bx bx-right-arrow"></i>
            </a>
        </div>
    </div>
      <div class="swiper-slide"><img src="../img/IB71.jpg" alt="">
        <div class="box-text">
      ...
      <div class="swiper-slide"><img src="../img/quiteplace.jpg" alt="">
        <div class="box-text">
