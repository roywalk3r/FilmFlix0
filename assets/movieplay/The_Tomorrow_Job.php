...
<html lang="en-US">
  <head>
    ...
    <link
      rel="canonical"
      href="https://rseann.helioho.st/assets/movieplay/The_Tomorrow_Job.html"
    />
    <title>Watch: The Tomorrow Job (2023)</title>
    ...
    <div class="section-container body-container">
      <div class="main-left">
        <div class="movie-play">
          <img
            src="https://www.themoviedb.org/t/p/original/hYCqInu2vhRysytIyifA41iw2Ek.jpg"
            alt="thumbnail"
            id="thumbnail"
          />
          <iframe
            src="https://vidsrc.to/embed/movie/1064912"
            allowfullscreen
            allowtransparency
            allow="autoplay"
            scrolling="no"
        ...
        <div class="about-movie container">
          <div class="sypnosis">
            <img src="../img/tomorrow_job.jpg" alt="movie poster" class="img" />
            <div class="content">
              <h2>Tomorrow Job</h2>
              <div class="req">
                <span><i class="bx bx-calendar-alt"></i> 2023</span>
                <span class="age-req"><i>PG 15</i></span>
                <span><i class="bx bx-time"></i> 1h 45min</span>
              </div>
              <p>
                A team of thieves use a time travel drug to trade places with
                their future selves to execute the ultimate heist. When
                interrupted on a job the team must fix their past mistakes to
                prevent disastrous consequences.
              </p>
              <span id="release"
                ><i class="fa fa-calendar"></i> Release date : 13<sup>th</sup>
                January 2023</span
              >
              <span id="writer"
                >Writer <span id="name">:Bruce Wemple </span></span
              >
              <div class="rating-card">
                <div class="rating-content">
                  <h2 class="card-heading">4.81/10</h2>
                  <span style="color: rgb(86, 39, 129)">414 reviews</span>
                </div>
                <div class="stars">
          ...
          <div class="cast">
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/2430984-grant-schumacher?language=en-US"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/gPN6DIZ8rbp1rIJd2sRmXwOS7x8.jpg"
                  alt="Grant Schumacher"
                  class="cast-img"
                />
              </a>
              <span class="cast-title">Grant Schumacher</span>
            </div>
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/1411925-lejon-woods?language=en-US"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/UCGgaPOfwQjYXkdTq7mmtZdde6.jpg"
                  alt="LeJon Woods"
                  class="cast-img"
                />
              </a>
              <span class="cast-title">LeJon Woods</span>
            </div>
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/2502875-chris-cimperman?language=en-US"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/kIZXU6m3MI3Xd2XcqegL3Dmri9C.jpg"
                  alt="Chris Cimperman"
                  class="cast-img"
                />
              </a>
              <span class="cast-title">Chris Cimperman</span>
            </div>
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/2502877-catharine-daddario?language=en-US"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/z8wNsyNuRyEtaSrdBq67ugwpHXB.jpg"
                  alt="Catharine Daddario"
                  class="cast-img"
                />
              </a>
              <span class="cast-title">Catharine Daddario</span>
            </div>
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/2874719-ariella-mastroianni?language=en-US"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src="../img/ariel.webp"
                  alt="Ariella Mastroianni"
                  class="cast-img"
                />
              </a>
              <span class="cast-title">Ariella Mastroianni</span>
            </div>
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/3851049-andrew-gombas?language=en-US"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
              ...
              <span class="cast-title">Andrew Gombas</span>
            </div>
          </div>
        </div>
        <!-- Download -->
        <div class="download">
          ...
          <div class="download-links">
            <a
              href="https://streamtape.com/v/oQYVY2W3joSJePL/The_Tomorrow_Job_%282023%29.mkv.mp4#"
              target="_blank"
              download
              >480p</a
            >
