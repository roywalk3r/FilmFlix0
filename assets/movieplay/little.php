...
<html lang="en-US">
  <head>
    ...
    <link
      rel="canonical"
      href="https://rseann.helioho.st/assets/movieplay/little.html"
    />
    <title>Watch: Little (2019)</title>
    ...
    <div class="section-container body-container">
      <div class="main-left">
        <div class="movie-play">
          <img
            src="https://parlemag.com/wp-content/uploads/2019/01/Little-movie-poster-social.jpg"
            alt="thumbnail"
            id="thumbnail"
          />
          <iframe
            src="https://vidsrc.to/embed/movie/526050"
            allowfullscreen
            allowtransparency
            allow="autoplay"
            scrolling="no"
        ...
        <div class="about-movie container">
          <div class="sypnosis">
            <img src="../img/little.jpg" alt="movie poster" class="img" />
            <div class="content">
              <h2>Little</h2>
              <div class="req">
              ...
              <p>
                Jordan Sanders, a take-no-prisoners tech mogul, wakes up one
                morning in the body of her 13-year-old self right before a
                do-or-die presentation. Her beleaguered assistant April is the
                only one in on the secret that her daily tormentor is now
                trapped in an awkward tween body, just as everything is on the
                line.
              </p>
              <span id="release"
              ...
              >
              <span id="writer"
                >Writer <span id="name">: Tracy Oliver</span></span
              >
          ...
          <div class="cast">
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/35705-regina-hall?language=en-US"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/jiFZ4xNrvUUZLBHnJu71CvdN4kj.jpg"
                  alt="Regina Hall"
                  class="cast-img"
                />
              </a>
              <span class="cast-title">Regina Hall</span>
            </div>
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/1455336-issa-rae?language=en-US"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src=" https://www.themoviedb.org/t/p/w300_and_h450_bestv2/1tX1T5ZNCMh2KYP1jMgfg8P26vm.jpg"
                  alt="Issa Rae"
                  class="cast-img"
                />
              </a>
              <span class="cast-title">Issa Rae</span>
            </div>
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/1407498-marsai-martin?language=en-US"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/hYErUiiesrm9jmiY1JTbwlxcN7l.jpg "
                  alt="Marsai Martin"
                  class="cast-img"
                />
              </a>
              <span class="cast-title">Marsai Martin</span>
            </div>
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/1120700-tone-bell?language=en-US"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src=" https://www.themoviedb.org/t/p/w300_and_h450_bestv2/fB06Xj5FgwvHcZESsNGMupGBTyY.jpg"
                  alt="Tone Bell"
                  class="cast-img"
                />
              </a>
              <span class="cast-title">Tone Bell</span>
            </div>
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/1227482-mikey-day?language=en-US"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/lIievLMSKtlvclOgDIOCf7ynz2e.jpg "
                  alt="Mikey Day"
                  class="cast-img"
                />
              </a>
              <span class="cast-title">Mikey Day</span>
            </div>
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/1828695-jd-mccrary?language=en-US"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/iOr3HQgtXoG1NeLxCux8fU5XOcQ.jpg "
                  alt="JD McCrary"
                  class="cast-img"
                />
              </a>
              <span class="cast-title">JD McCrary</span>
            </div>
          </div>
        </div>
        <!-- Download -->
        <div class="download">
          ...
          <div class="download-links">
            <a
              href=" https://streamtape.com/v/DevxDPVpyZCLXr/Little_%282019%29_BluRay_720p_%28fzmovies.net%29_1f791c87f7979b296ce0784c910a502c.mkv.mp4#
  "
              target="_blank"
              download
              >480p</a
