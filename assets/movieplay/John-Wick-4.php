...
<html lang="en-US">
  <head>
    ...
    <link
      rel="canonical"
      href="https://rseann.helioho.st/assets/movieplay/John-Wick.html"
    />
    <title>Watch: John Wick: Chapter 4 (2023)</title>
    ...
    <div class="section-container body-container">
      <div class="main-left">
        <div class="movie-play">
          <img
            src="../img/john-wick-cover.jpg"
            alt="thumbnail"
            id="thumbnail"
          />
          <iframe
            src="https://vidsrc.to/embed/movie/tt10366206"
            allowfullscreen
            allowtransparency
            allow="autoplay"
            scrolling="no"
        ...
        <div class="about-movie container">
          <div class="sypnosis">
            <img
              src="../img/John_Wick_TeaserPoster.jpg"
              alt="movie poster"
              class="img"
            />
            <div class="content">
              ...
              <span id="release"
                ><i class="fa fa-calendar"></i> Release date : 22<sup>nd</sup>
                March 2023
              </span>
              <span id="writer"
                >Writer <span id="name">:Michael Finch </span></span
              >
          ...
          <div class="cast">
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/6384-keanu-reeves?language=en-US"
                target="_blank"
            ...
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/1341-donnie-yen?language=en-US"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/hTlhrrZMj8hZVvD17j4KyAFWBHc.jpg"
                  alt="Donnie Yen"
                  class="cast-img"
                />
              </a>
            ...
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/137905-bill-skarsgard?language=en-US"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/cFQN6rLSSLhGx8NQI7krYWwdRpl.jpg"
                  alt="Bill Skarsgård"
                  class="cast-img"
                />
              </a>
              <span class="cast-title">Bill Skarsgård</span>
            </div>
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/6972-ian-mcshane?language=en-US"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/qh9RTLbnr128TZLdGuXwUH9mdBM.jpg "
                  alt="Ian McShane"
                  class="cast-img"
                />
              </a>
            ...
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/2975-laurence-fishburne?language=en-US"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src=" https://www.themoviedb.org/t/p/w300_and_h450_bestv2/iwx7h0AfWMm9K4sMmhru3ShSra.jpg"
            ...
            <div class="cast-box">
              <a href="" target="_blank" title="read about actor on MovieDB">
                <img
                  src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/22mVtEXZbpt0J7S0LhIhdkfRrZV.jpg"
                  alt=""
                  class="cast-img"
                />
              </a>
        ...
        <div class="download">
          ...
          <div class="download-links">
            <a
              href="https://streamtape.com/v/MrYXrW9aJeceMw/John_Wick_Chapter_4_%282023%29.mp4#"
              target="_blank"
              download
              >480p</a
            >
