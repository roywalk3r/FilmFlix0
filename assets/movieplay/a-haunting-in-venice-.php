...
<html lang="en-US">
  <head>
    ...
    />
    <title>Watch: A Haunting in Venice </title>
    <!-- Local Links -->
...
<form class="signup-form" id="regform" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
    ...
    <div class="main-left">
        ...
        <img
            src="https://www.themoviedb.org/t/p/original/kHlX3oqdD4VGaLpB8O78M25KfdS.jpg"
            alt="thumbnail"
            id="thumbnail"
          />
          <iframe
            src="https://vidsrc.to/embed/movie/945729"
            allowfullscreen
            allowtransparency
            allow="autoplay"
            scrolling="no"
        ...
        <div class="about-movie body-container">
          <div class="sypnosis">
            <img src="../img/hunt.jpg" alt="" class="img" />
            <div class="content">
        ...
        <!-- <p>Genre: Mystery</p> -->
              ...
              <p>
              Celebrated sleuth Hercule Poirot, now retired and living in self-imposed exile in Venice, reluctantly attends a Halloween séance at a decaying, haunted palazzo. When one of the guests is murdered, the detective is thrust into a sinister world of shadows and secrets.              </p>
              <span id="release"
                ><i class="fa fa-calendar"></i> Release date :2023-09-15<sup>th</sup>
                July 2023</span
              >
              <span id="writer"
                >Writer <span id="name">: Kenneth Branagh </span></span
              >
