...
<html lang="en-US">
  <head>
    ...
    <link
      rel="canonical"
      href="https://rseann.helioho.st/assets/movieplay/Blue-Beetle.html"
    />
    <title>Watch: Blue Beetle (2023)</title>
    ...
    <div class="section-container body-container">
      <div class="main-left">
        <div class="movie-play">
          <img
            src="https://www.themoviedb.org/t/p/original/x0GGS0r4ig4fMMehTRVPyXkxKTI.jpg"
            alt="thumbnail"
            id="thumbnail"
          />
          <iframe
            src="https://vidsrc.to/embed/movie/565770"
            allowfullscreen
            allowtransparency
            allow="autoplay"
            scrolling="no"
        ...
        <div class="about-movie container">
          <div class="sypnosis">
            <img src="../img/blue-beetle.jpg" alt="movie poster" class="img" />
            <div class="content">
              <h2>Blue Beetle</h2>
              <div class="req">
                <span><i class="bx bx-calendar-alt"></i>2023</span>
                <span class="age-req"><i>PG13</i></span>
                <span><i class="bx bx-time">2hr 8min</i></span>
              </div>
              <p>
                Recent college grad Jaime Reyes returns home full of aspirations
                for his future, only to find that home is not quite as he left
                it. As he searches to find his purpose in the world, fate
                intervenes when Jaime unexpectedly finds himself in possession
                of an ancient relic of alien biotechnology: the Scarab.
              </p>
              <span id="release"
                ><i class="fa fa-calendar"></i>Release date : 18<sup>th</sup>
                August 2023
              </span>
              <span id="writer"
                >Writer<span id="name">: Gareth Dunnet-Alcocer</span></span
              >
          ...
          <div class="cast">
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/1185997-xolo-mariduena"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/tJMI7BpjlhHSMpzSz9e1XxygnKd.jpg"
                  alt="Xolo Mariduena"
                  class="cast-img"
                />
              </a>
              <span class="cast-title">Xolo Mariduena</span>
            </div>
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/1622590-bruna-marquezine"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/mGDhenXwsFRaaz1PjbJjDkn2snc.jpg"
                  alt="Bruna Marquezine"
                  class="cast-img"
                />
              </a>
              <span class="cast-title">Bruna Marquezine</span>
            </div>
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/7370-damian-alcazar"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/6IAlrZ2yXubmmVaRsF7fdaP3N7C.jpg"
                  alt="Damián Alcázar"
                  class="cast-img"
                />
              </a>
              <span class="cast-title">Damián Alcázar</span>
            </div>
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/17688-raoul-trujillo"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/dIfHIt1pgnYW9oCksc0DdoY5Mt5.jpg"
                  alt="Raoul Max Trujillo"
                  class="cast-img"
                />
              </a>
              <span class="cast-title">Raoul Max Trujillo</span>
            </div>
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/270-adriana-barraza"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/1aE7wu22bdgVTa0PMKXbAOSLiZn.jpg"
                  alt="Adriana Barraza"
                  class="cast-img"
                />
              </a>
              <span class="cast-title">Adriana Barraza</span>
            </div>
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/4038-susan-sarandon"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/oHYYL8bNakAREaLUBtMul5uMG0A.jpg"
                  alt="Susan Sarandon"
                  class="cast-img"
                />
              </a>
              <span class="cast-title">Susan Sarandon</span>
            </div>
          </div>
        </div>
        <!-- Download -->
        ...
        <div class="swiper mySwiper">
          <div class="swiper-wrapper">
            <div class="swiper-slide">
              ...
              <div class="box-text">
                <a
                  href="../movieplay/The_Tomorrow_Job.html"
            ...
            <div class="swiper-slide">
              ...
              <div class="box-text">
                <a
                  href="../movieplay/transformers.html"
                  class="watch-btn play-btn"
                >
                  <i class="bx bx-right-arrow"></i>
                </a>
            ...
            <div class="swiper-slide">
              ...
              <div class="box-text">
                <a
                  href="../movieplay/acrosstheverse.html"
                  class="watch-btn play-btn"
                >
                  <i class="bx bx-right-arrow"></i>
                </a>
