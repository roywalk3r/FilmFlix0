...
<form class="signup-form" id="regform" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
    ...
    <div class="main-left">
        ...
        <img
            src="https://www.themoviedb.org/t/p/original/CXiTU57jzzFkPjLFC7fjqE1vxh.jpg"
            alt="thumbnail"
            id="thumbnail"
          />
          <iframe
            src="https://vidsrc.to/embed/movie/tt11737520"
            allowfullscreen
            allowtransparency
            allow="autoplay"
            scrolling="no"
        ...
        <div class="about-movie body-container">
          <div class="sypnosis">
            <img src="../img/onePiece-M.jpg" alt="" class="img" />
            <div class="content">
              <h2>ONE PIECE </h2>
        <!-- <p>Genre: Fantasy</p> -->
              ...
              <p>
              With his straw hat and ragtag crew, young pirate Monkey D. Luffy goes on an epic voyage for treasure in this live action adaptation of the popular manga.              </p>
              <span id="release"
                ><i class="fa fa-calendar"></i> Release date :0000-00-00<sup>th</sup>
                July 2023</span
              >
              <span id="writer"
                >Writer <span id="name">: Steven Maeda </span></span
              >
...
<div class="cast">
    <div class="cast-box"><img src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/cjgF30gIyrHMzEk2dvilmRanDAL.jpg" alt="Iñaki Godoy" class="cast-img" /><span class="cast-title">Iñaki Godoy</span></div><div class="cast-box"><img src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/kIrLJmJCGc2fRAkVnBJXwAL7gAM.jpg" alt="Mackenyu" class="cast-img" /><span class="cast-title">Mackenyu</span></div><div class="cast-box"><img src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/y23GTdDPcryBVtSWjY9q2O9nzwV.jpg" alt="Emily Rudd" class="cast-img" /><span class="cast-title">Emily Rudd</span></div><div class="cast-box"><img src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/foaSZvcg70p2gxiJxqtGo3YqWIC.jpg" alt="Jacob Gibson" class="cast-img" /><span class="cast-title">Jacob Gibson</span></div><div class="cast-box"><img src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/sQIZYC50kIUfLpGqrjqzi5WD9Th.jpg" alt="Taz Skylar" class="cast-img" /><span class="cast-title">Taz Skylar</span></div><div class="cast-box"><img src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/vnylF0jSWOdQyRWAsQgV3oA9dk.jpg" alt="Vincent Regan" class="cast-img" /><span class="cast-title">Vincent Regan</span></div></div>
        </div>
