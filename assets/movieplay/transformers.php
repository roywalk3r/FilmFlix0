...
<html lang="en-US">
  <head>
    ...
    <link
      rel="canonical"
      href="https://rseann.helioho.st/assets/movieplay/transformers.html"
    />
    <title>Watch: Transformers: Rise of the Beasts (2023)</title>
    ...
    <div class="section-container body-container">
      <div class="main-left">
        <div class="movie-play">
          <img
            src="../img/transformers_cover.jpg"
            alt="thumbnail"
            id="thumbnail"
          />
          <iframe
            src="https://vidsrc.to/embed/movie/667538"
            allowfullscreen
            allowtransparency
            allow="autoplay"
            scrolling="no"
        ...
        <div class="about-movie container">
          <div class="sypnosis">
            <img src="../img/transformers.jpg" alt="movie poster" class="img" />
            <div class="content">
              ...
              <p>
                When a new threat capable of destroying the entire planet
                emerges, Optimus Prime and the Autobots must team up with a
                powerful faction known as the Maximals. With the fate of
                humanity hanging in the balance, humans Noah and Elena will do
                whatever it takes to help the Transformers as they engage in the
          ...
          <div class="cast">
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/1560244-anthony-ramos?language=en-US"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/2Stnm8PQI7xHkVwINb4MhS7LOuR.jpg "
                  alt="Anthony Ramos"
                  class="cast-img"
                />
              </a>
              <span class="cast-title">Anthony Ramos</span>
            </div>
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/1676520-dominique-fishback?language=en-US"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/zduC0PM7xKzFX4F7DH8CCt5gt6O.jpg "
                  alt="Dominique Fishback"
                  class="cast-img"
                />
              </a>
              <span class="cast-title">Dominique Fishback</span>
            </div>
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/19540-peter-cullen?language=en-US"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/9Snf4fBUkk5MrAjqtNtgZRJYJbj.jpg "
                  alt="Peter Cullen"
                  class="cast-img"
                />
              </a>
              <span class="cast-title">Peter Cullen</span>
            </div>
            <div class="cast-box">
              <a href="" target="_blank" title="read about actor on MovieDB">
                <img
                  src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/9riPBfsWpzEzh2y9ucxTW22iakI.jpg"
                  alt="Ron Perlman"
                  class="cast-img"
                />
              </a>
            ...
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/22970-peter-dinklage?language=en-US"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/9CAd7wr8QZyIN0E7nm8v1B6WkGn.jpg "
                  alt="Peter Dinklage"
                  class="cast-img"
                />
              </a>
              <span class="cast-title">Peter Dinklage</span>
            </div>
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/1620-michelle-yeoh?language=en-US"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/6oxvfyrrM3YmhgFZSqc8ESqPZoC.jpg"
                  alt="Michelle Yeoh"
                  class="cast-img"
                />
              </a>
        ...
        <div class="download">
          ...
          <div class="download-links">
            <a
              href="https://streamtape.com/v/8GeMkRyOWycokaq/Transformers_Rise_of_the_Beasts_%282023%29.mkv.mp4#"
              target="_blank"
              download
              >480p</a
            >
