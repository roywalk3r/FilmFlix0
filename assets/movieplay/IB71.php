...
<html lang="en-US">
  <head>
    ...
    <link
      rel="canonical"
      href="https://rseann.helioho.st/assets/movieplay/IB71.html"
    />
    <title>Watch: IB17</title>
    <!-- Local Links -->
    ...
    <div class="section-container body-container">
      <div class="main-left">
        <div class="movie-play">
          <img
            src="https://assets-in.bmscdn.com/discovery-catalog/events/et00312966-nyfsmdrqev-landscape.jpg "
            alt="thumbnail"
            id="thumbnail"
          />
          <iframe
            src="https://vidsrc.to/embed/movie/tt15073166"
            allowfullscreen
            allowtransparency
            allow="autoplay"
            scrolling="no"
        ...
        <div class="about-movie container">
          <div class="sypnosis">
            <img src="../img/IB71.jpg" alt="movie poster" class="img" />
            <div class="content">
              <h2>IB71</h2>
              <div class="req">
                <span><i class="bx bx-calendar-alt"></i> 2023</span>
                <span class="age-req"><i>PG 13</i></span>
                <span><i class="bx bx-time"></i> 1h 57min</span>
              </div>
              <p>
                A two- front war between Indian intelligence agencies and the
                Pakistani establishment.
              </p>
              <span id="release"
                ><i class="fa fa-calendar"></i> Release date : 12<sup>th</sup>
                May 2023</span
              >
              <span id="writer"
                >Writer <span id="name">: Sankalp Reddy</span></span
              >
          ...
          <div class="cast">
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/1118194-vidyut-jamwal?language=en-US"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/fs5kBOtxDvK77P33n6o1jBc7Aip.jpg "
                  alt="Vidyut Jammwal"
                  class="cast-img"
                />
              </a>
              <span class="cast-title">Vidyut Jammwal</span>
            </div>
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/11861-dalip-tahil?language=en-US"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/4kgTd5aKh3IRxrJ7uG5h9mojb57.jpg "
                  alt="Dalip Tahil"
                  class="cast-img"
                />
              </a>
              <span class="cast-title">Dalip Tahil</span>
            </div>
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/6217-anupam-kher?language=en-US"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/f7hWJ4tvzR7uXmYoTiB41TpQ2NZ.jpg"
                  alt="Anupam Kher"
                  class="cast-img"
                />
              </a>
              <span class="cast-title">Anupam Kher</span>
            </div>
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/2554387-vishal-jethwa?language=en-US"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/oqt3Ea43y9EAcCb0DrA22TV08kt.jpg"
                  alt="Vishal Jethwa"
                  class="cast-img"
                />
              </a>
              <span class="cast-title">Vishal Jethwa</span>
            </div>
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/1726391-hobby-dhaliwal?language=en-US"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src=" https://www.themoviedb.org/t/p/w300_and_h450_bestv2/4rbEhi5OHflNc8jtkTIhXgmbRfi.jpg"
                  alt="Hobby Dhaliwal"
                  class="cast-img"
                />
              </a>
              <span class="cast-title">Hobby Dhaliwal</span>
            </div>
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/1638525-nissar-khan?language=en-US"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/zjO9FJ5WfPdUX78KFcv3V2ct6Ab.jpg "
                  alt="Nissar Khan"
                  class="cast-img"
                />
              </a>
              <span class="cast-title">Nissar Khan</span>
            </div>
          </div>
        </div>
        <!-- Download -->
        <div class="download">
          ...
          <div class="download-links">
            <a
              href="https://streamtape.com/v/abRxzXMxmlSxr92/IB_71_%282023%29_%28NetNaija.com%29.mkv.mp4#"
              target="_blank"
              download
              >480p</a
            >
      ...
      <div class="right-sidebar">
        ...
        <div class="related-movies">
            ...
            <div class="movie">
              ...
              <div class="movie-container">
                ...
                <span class="bottom-content">
                  <p>Movie</p>
                  <p>1 Eps</p>
                  <p class="fas fa-bookmark">&nbsp;177k</p>
                </span>
              </div>
            </div>
          </a>
          <a href="transporter.html">
            <div class="movie">
              <img src="../img/transporter2.jpg" alt="" />
              <div class="movie-container">
                <small>Action</small>
                <h4>Transporter 2</h4>
                <span class="bottom-content">
