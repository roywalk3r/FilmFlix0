...
<html lang="en-US">
  <head>
    ...
    <link
      rel="canonical"
      href="https://rseann.helioho.st/assets/movieplay/red-door.html"
    />
    <title>Watch: Insidious: The Red Door (2023)</title>
    ...
    <div class="section-container body-container">
      <div class="main-left">
        <div class="movie-play">
          <img
            src="../img/insidious_cover.png"
            alt="thumbnail"
            id="thumbnail"
          />
          <iframe
            src="https://vidsrc.to/embed/movie/tt13405778"
            allowfullscreen
            allowtransparency
            allow="autoplay"
            scrolling="no"
        ...
        <div class="about-movie container">
          <div class="sypnosis">
            <img src="../img/insidius.jpg" alt="movie poster" class="img" />
            <div class="content">
              <h2>Insidious: The Red Door</h2>
              <div class="req">
                <span><i class="bx bx-calendar-alt"></i> 2023</span>
                <span class="age-req"><i>PG-13</i></span>
                <span><i class="bx bx-time"></i> 1h 47min</span>
              </div>
              <p>
                To put their demons to rest once and for all, Josh Lambert and a
                college-aged Dalton Lambert must go deeper into The Further than
                ever before, facing their family's dark past and a host of new
                and more horrifying terrors that lurk behind the red door.
              </p>
              <span id="release"
              ...
              <span id="writer"
                >Writer <span id="name">: Leigh Whannell</span></span
              >
          ...
          <div class="cast">
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/17181-ty-simpkins?language=en-US"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/iGPK0aZeKBkyBAjg7zl7AoZ7r2l.jpg"
                  alt="Ty Simpkins"
                  class="cast-img"
                />
              </a>
              <span class="cast-title">Ty Simpkins</span>
            </div>
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/17178-patrick-wilson?language=en-US"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/tc1ezEfIY8BhCy85svOUDtpBFPt.jpg"
                  alt="Patrick Wilson"
                  class="cast-img"
                />
              </a>
              <span class="cast-title">Patrick Wilson</span>
            </div>
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/3704264-sinclair-daniel?language=en-US"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/lvlGYC70bTyfbRLbj4b8YyMk4Xi.jpg"
                  alt="Sinclair Daniel"
                  class="cast-img"
                />
              </a>
              <span class="cast-title">Sinclair Daniel</span>
            </div>
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/9827-rose-byrne?language=en-US"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/4oQWCLK7gd6RNKF0WJipJo7TyFP.jpg "
                  alt="Rose Byrne"
                  class="cast-img"
                />
              </a>
              <span class="cast-title">Rose Byrne</span>
            </div>
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/7401-lin-shaye?language=en-US"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/aL87Za52elH81zMiXQn5C7AXAeg.jpg "
                  alt="Lin Shaye"
                  class="cast-img"
                />
              </a>
              <span class="cast-title">Lin Shaye</span>
            </div>
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/765-hiam-abbass?language=en-US"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/hkzC5aJKTiuCchBpybaHDVngYZW.jpg"
                  alt="Hiam Abbass"
                  class="cast-img"
                />
              </a>
              <span class="cast-title">Hiam Abbass</span>
            </div>
          </div>
        </div>
        <!-- Download -->
        <div class="download">
          ...
          <div class="download-links">
            <a
              href="https://streamtape.com/v/1d4ldomZL3IevGd/Insidious.The.Red.Door.2023.mkv.mp4#"
              target="_blank"
              download
              >480p</a
            >
      ...
      <div class="right-sidebar">
        ...
        <div class="related-movies">
          ...
          <a href="resident-evil.html">
            <div class="movie">
              <img src="../img/resident-evil.jpg" alt="" />
              <div class="movie-container">
                <small>Horror</small>
                <h4>Resident Evil</h4>
                <span class="bottom-content">
        ...
        <div class="swiper mySwiper">
          <div class="swiper-wrapper">
            <div class="swiper-slide">
              <img src="../img/quiteplace.jpg" alt="" />
              <div class="box-text">
                <a href="../movieplay/quite" class="watch-btn play-btn">
