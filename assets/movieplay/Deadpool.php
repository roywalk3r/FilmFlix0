...
<html lang="en-US">
  <head>
    ...
    <link
      rel="canonical"
      href="https://rseann.helioho.st/assets/movieplay/Deadpool.html"
    />
    <title>Watch: Deadpool (2016)</title>
    ...
    <div class="section-container body-container">
      <div class="main-left">
        <div class="movie-play">
          <img
            src=" https://imgs.search.brave.com/9EdgPTxD3Rxi9DC_6dvKM3KGh_BnQODZzpwNd38mx48/rs:fit:860:0:0/g:ce/aHR0cHM6Ly93d3cu/cGl4ZWxzdGFsay5u/ZXQvd3AtY29udGVu/dC91cGxvYWRzLzIw/MTYvMDMvRGVhZHBv/b2wtQmFja2dyb3Vu/ZHMtNjIweDM0OS5q/cGc"
            alt="thumbnail"
            id="thumbnail"
          />
          <iframe
            src="https://vidsrc.to/embed/movie/tt1431045"
            allowfullscreen
            allowtransparency
            allow="autoplay"
            scrolling="no"
        ...
        <div class="about-movie container">
          <div class="sypnosis">
            <img src="../img/deadpool.jpg" alt="" class="img" />
            <div class="content">
              <h2>Deadpool</h2>
              <div class="req">
                <span><i class="bx bx-calendar-alt"></i> 2016</span>
                <span class="age-req"><i>17+</i></span>
                <span><i class="bx bx-time"></i> 1h 48min</span>
              </div>
              <p>
                The origin story of former Special Forces operative turned
                mercenary Wade Wilson, who, after being subjected to a rogue
                experiment that leaves him with accelerated healing powers,
                adopts the alter ego Deadpool. Armed with his new abilities and
                a dark, twisted sense of humor, Deadpool hunts down the man who
                nearly destroyed his life.
              </p>
              <span id="release"
                ><i class="fa fa-calendar"></i> Release date : 2<sup>nd</sup>
                December 2016</span
              >
              <span id="writer"
                >Writer <span id="name">: Paul Wernick</span></span
              >
          ...
          <div class="cast">
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/10859-ryan-reynolds?language=en-US"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/4SYTH5FdB0dAORV98Nwg3llgVnY.jpg"
                  alt="Ryan Reynolds"
                  class="cast-img"
                />
              </a>
              <span class="cast-title">Ryan Reynolds</span>
            </div>
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/54882-morena-baccarin?language=en-US"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/tXRXo0pGFPq1sMr5u6ELjLLfbsq.jpg"
                  alt="Morena Baccarin"
                  class="cast-img"
                />
              </a>
              <span class="cast-title">Morena Baccarin</span>
            </div>
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/1047649-ed-skrein?language=en-US"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/AaMTvZkroI8uo5JXQiJ5pSLEgSJ.jpg "
                  alt="Ed Skrein"
                  class="cast-img"
                />
              </a>
              <span class="cast-title">Ed Skrein</span>
            </div>
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/51990-t-j-miller?language=en-US"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/rRrVvBxOkyYM5XdLXimShHR1Itn.jpg"
                  alt="T.J. Miller"
                  class="cast-img"
                />
              </a>
              <span class="cast-title">T.J. Miller</span>
            </div>
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/78452-gina-carano?language=en-US"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/hLEVSHW8vkogPA99Hhf1siasqbQ.jpg"
                  alt="Gina Carano"
                  class="cast-img"
                />
              </a>
              <span class="cast-title">Gina Carano</span>
            </div>
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/122750-leslie-uggams?language=en-US"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/peLaqLcs3y2WY4TbrLOXQGt9I8S.jpg"
                  alt="Leslie Uggams"
                  class="cast-img"
                />
              </a>
              <span class="cast-title">Leslie Uggams</span>
            </div>
          </div>
        </div>
        <!-- Download -->
        <div class="download">
          ...
          <div class="download-links">
            <a
              href="https://streamtape.com/v/bZ1P7YbXZ2FPMYr/Deadpool_%282016%29_BluRay_720p.mkv.mp4#"
              target="_blank"
              download
              >480p</a
            >
      ...
      <div class="right-sidebar">
        ...
        <div class="related-movies">
          <a href="The_Tomorrow_Job.html">
            <div class="movie">
              <img src="../img/tomorrow_job.jpg" alt="" />
              <div class="movie-container">
                <small>sci-fi</small>
                <h4>The Tomorrow Job</h4>
                <span class="bottom-content">
                  <p>Movie</p>
                  <p>1 Eps</p>
                  <p class="fas fa-bookmark">&nbsp; 53k</p>
                </span>
              </div>
            </div>
          </a>
          <a href="Wolverine.html">
            <div class="movie">
              <img src="../img/the-wolverine.jpg" alt="" />
              <div class="movie-container">
                <small>action</small>
                <h4>The Wolverine</h4>
                <span class="bottom-content">
