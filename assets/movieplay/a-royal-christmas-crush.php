...
<html lang="en-US">
  <head>
    ...
    <link
      rel="canonical"
      href="https://rseann.helioho.st/../movieplay/a-royal-christmas-crush.php"
    />
    ...
    <div class="section-container body-container">
      <div class="main-left">
        <div class="movie-play">
          <img
            src="https://www.themoviedb.org/t/p/w533_and_h300_bestv2/8hblp3Kml3mrP8TeSUZzkfZPmAd.jpg"
            alt="thumbnail"
            id="thumbnail"
          />
          <iframe
            src="https://vidsrc.to/embed/movie/tt28077855"
            allowfullscreen
            allowtransparency
            allow="autoplay"
            scrolling="no"
      ...
      <div class="right-sidebar">
        ...
        <div class="related-movies">
          <a href="return-to-christmas-creek.php">
            <div class="movie">
              <img src="../img/return-to-christmas-creek.jpg" alt="" />
              <div class="movie-container">
                <small>similar</small>
                <h4>Return To Christmas</h4>
        ...
        <div class="swiper mySwiper">
          <div class="swiper-wrapper">
            <div class="swiper-slide">
              ...
              <div class="box-text">
                <a href="../movieplay/IB71.php" class="watch-btn play-btn">
            ...
            <div class="swiper-slide">
              ...
              <div class="box-text">
                <a
                  href="../movieplay/transporter.php"
            ...
            <div class="swiper-slide">
              ...
              <div class="box-text">
                <a
                  href="../movieplay/a-royal-christmas-crush.php"
                  class="watch-btn play-btn"
                >
                  <i class="bx bx-right-arrow"></i>
                </a>
            ...
            <div class="swiper-slide">
              ...
              <div class="box-text">
                <a
                  href="../movieplay/johnny-english.php"
                  class="watch-btn play-btn"
                >
                  <i class="bx bx-right-arrow"></i>
                </a>
            ...
            <div class="swiper-slide">
              ...
              <div class="box-text">
                <a
                  href="../movieplay/quite-place.php"
                  class="watch-btn play-btn"
                >
                  <i class="bx bx-right-arrow"></i>
                </a>
