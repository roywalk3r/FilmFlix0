...
<html lang="en-US">
  <head>
    ...
    />
    <title>Watch: Who Framed Roger Rabbit</title>
    <!-- Local Links -->
...
<form class="signup-form" id="regform" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
    ...
    <div class="main-left">
        ...
        <img
            src="https://www.themoviedb.org/t/p/original/mED6iGO5jCD3enjE2IuINrxxZJa.jpg"
            alt="thumbnail"
            id="thumbnail"
          />
          <iframe
            src="https://vidsrc.to/embed/movie/856"
            allowfullscreen
            allowtransparency
            allow="autoplay"
            scrolling="no"
        ...
        <div class="about-movie body-container">
          <div class="sypnosis">
            <img src="../img/roger.jpg" alt="" class="img" />
            <div class="content">
        ...
        <!-- <p>Genre: Fantasy</p> -->
              ...
              <p>
              Toon star Roger is worried that his wife Jessica is playing pattycake with someone else, so the studio hires detective Eddie Valiant to snoop on her. But the stakes are quickly raised when Marvin Acme is found dead and Roger is the prime suspect.              </p>
              <span id="release"
                ><i class="fa fa-calendar"></i> Release date :1998-06-21<sup>th</sup>
                July 2023</span
              >
              <span id="writer"
                >Writer <span id="name">: Robert Zemeckis </span></span
              >
...
<div class="cast">
    <div class="cast-box"><img src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/qOeE7bVHAsNTbP77Qk6TwrrWHZc.jpg" alt="Bob Hoskins" class="cast-img" /><span class="cast-title">Bob Hoskins</span></div><div class="cast-box"><img src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/nxVjpyb3UrfbPZnEyDNlQVlFAs5.jpg" alt="Christopher Lloyd" class="cast-img" /><span class="cast-title">Christopher Lloyd</span></div><div class="cast-box"><img src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/cgyR6QLZdC6apR8eHnhgqDQmqyr.jpg" alt="Joanna Cassidy" class="cast-img" /><span class="cast-title">Joanna Cassidy</span></div><div class="cast-box"><img src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/iZ32sao16c0ZZIg30hwRfqNHNui.jpg" alt="Charles Fleischer" class="cast-img" /><span class="cast-title">Charles Fleischer</span></div><div class="cast-box"><img src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/mU26KTVahf2OQ5vUpdh5bkad9nh.jpg" alt="Stubby Kaye" class="cast-img" /><span class="cast-title">Stubby Kaye</span></div><div class="cast-box"><img src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/6S1WHKzfLw02fFKjiN9LpvYM4XU.jpg" alt="Alan Tilvern" class="cast-img" /><span class="cast-title">Alan Tilvern</span></div></div>
        </div>
...
<div class="download">
  ...
  <a href="transformers.html">
    <div class="movie">
      <img src="../img/transformers.jpg" alt="Transformers Rise Of The Beast" />
      <div class="movie-container">
        <small>similar</small>
