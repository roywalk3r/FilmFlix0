...
<html lang="en-US">
  <head>
    ...
    <link
      rel="canonical"
      href="https://rseann.helioho.st/assets/movieplay/Lucy.html"
    />
    <title>Watch: Lucy (2014)</title>
    <!-- Local Links -->
    ...
    <div class="section-container body-container">
      <div class="main-left">
        <div class="movie-play">
          <img
            src="https://akm-img-a-in.tosshub.com/indiatoday/images/story/201408/lucy_story_650_080114111857.jpg?"
            alt="thumbnail"
            id="thumbnail"
          />
          <iframe
            src="https://vidsrc.to/embed/movie/tt2872732"
            allowfullscreen
            allowtransparency
            allow="autoplay"
            scrolling="no"
        ...
        <div class="about-movie container">
          <div class="sypnosis">
            <img src="../img/Lucy.jpg" alt="movie poster" class="img" />
            <div class="content">
              <h2>Lucy</h2>
              <div class="req">
                <span><i class="bx bx-calendar-alt"></i> 2014</span>
                <span class="age-req"><i>PG 13</i></span>
                <span><i class="bx bx-time"></i> 1h 29min</span>
              </div>
              <p>
                Lucy is a science fiction thriller that follows the story of a
                woman who gains extraordinary mental abilities after a
                mysterious drug is accidentally absorbed into her bloodstream.
                As she unlocks her mind's full potential, Lucy embarks on a
                mission to harness her newfound powers while facing dangerous
                adversaries determined to control her abilities.
              </p>
              <span id="release"
              ...
              >
              <span id="writer"
                >Writer <span id="name">: Luc Benson</span></span
              >
          ...
          <div class="cast">
            <div class="cast-box">
              <img
                src="https://upload.wikimedia.org/wikipedia/commons/thumb/2/2a/Scarlett_Johansson_by_Gage_Skidmore_2_%28cropped%2C_2%29.jpg/220px-Scarlett_Johansson_by_Gage_Skidmore_2_%28cropped%2C_2%29.jpg"
                alt=""
                class="cast-img"
              />
            ...
            <div class="cast-box">
              <img
                src="https://upload.wikimedia.org/wikipedia/commons/thumb/e/e4/Morgan_Freeman_Deauville_2018.jpg/220px-Morgan_Freeman_Deauville_2018.jpg"
                alt=""
                class="cast-img"
              />
              <span class="cast-title">Morgan Freeman</span>
            </div>
            <div class="cast-box">
              <img
                src="https://upload.wikimedia.org/wikipedia/commons/thumb/5/5d/Choi_Min-sik.jpg/220px-Choi_Min-sik.jpg"
                alt=""
                class="cast-img"
              />
              <span class="cast-title"> Min-sik Choi </span>
            </div>
            <div class="cast-box">
              <img
                src="https://upload.wikimedia.org/wikipedia/commons/thumb/6/61/Amr_Waked.jpg/220px-Amr_Waked.jpg"
                alt=""
                class="cast-img"
              />
              <span class="cast-title">Amr Waked </span>
            </div>
            <div class="cast-box">
              <img
                src="https://upload.wikimedia.org/wikipedia/commons/c/c5/Comic_Con_Germany_2018_by-RaBoe_288_%28cropped%29.jpg"
                alt=""
                class="cast-img"
              />
              <span class="cast-title">Pilou Asbæk </span>
            </div>
            <div class="cast-box">
              <img
                src="https://upload.wikimedia.org/wikipedia/commons/thumb/1/1d/LioTiptonTIFFSept2011.jpg/398px-LioTiptonTIFFSept2011.jpg"
                alt=""
                class="cast-img"
              />
              <span class="cast-title">Analeigh Tipton</span>
            </div>
          </div>
        </div>
        <!-- Download -->
        <div class="download">
          ...
          <div class="download-links">
            <a
              href="https://streamtape.com/v/qWdRB0JQxzTzdk1/Lucy.mp4#"
              target="_blank"
              download
              >480p</a
            >
