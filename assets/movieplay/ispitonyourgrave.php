...
<html lang="en-US">
  <head>
    ...
    <link
      rel="canonical"
      href="https://rseann.helioho.st/assets/movieplay/ispitonyourgrave.html"
    />
    <title>Watch: I spit On Yor Grave 2 (2013)</title>
    <!-- Local Links -->
    ...
    <div class="section-container body-container">
      <div class="main-left">
        <div class="movie-play">
          <img
            src="https://i.ytimg.com/vi/f6QatrDdHVc/maxresdefault.jpg"
            alt="thumbnail"
            id="thumbnail"
          />
          <iframe
            src="https://vidsrc.to/embed/movie/tt2537176"
            allowfullscreen
            allowtransparency
            allow="autoplay"
            scrolling="no"
        ...
        <div class="about-movie container">
          <div class="sypnosis">
            <img
              src="../img/i-spit-grave-2.jpg"
              alt="movie poster"
              class="img"
            />
            <div class="content">
              <h2>I Spit on Your Grave 2</h2>
              <div class="req">
                <span><i class="bx bx-calendar-alt"></i> 2013</span>
                <span class="age-req"><i>PG 13</i></span>
                <span><i class="bx bx-time"></i> 1h 46min</span>
              </div>
              <p>
                When Katie innocently accepts an offer to have new photos taken
                for her portfolio, the experience quickly turns into a nightmare
                of rape, torture and kidnapping. Now, she will have to find the
                strength to exact her brutal revenge.
              </p>
              <span id="release"
                ><i class="fa fa-calendar"></i> Release date : 20<sup>th</sup>
                September 2013</span
              >
              <span id="writer"
                >Writer <span id="name">: Niel Elman</span></span
              >
          ...
          <div class="cast">
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/1154842-jemma-dallender"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/c4IE2WHf4EZStWWBHGWQJyX5uaF.jpg"
                  alt="Jemma Dallender"
                  class="cast-img"
                />
              </a>
              <span class="cast-title">Jemma Dallender</span>
            </div>
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/97430-joe-absolom"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/hhn9NBY72oZM6ulN2j2cvix3B8x.jpg"
                  alt="Joe Absolom"
                  class="cast-img"
                />
              </a>
              <span class="cast-title">Joe Absolom</span>
            </div>
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/1202317-aleksandar-aleksiev"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/bvpfp7CFvEw6KwxAzCCHKfkSsoF.jpg "
                  alt="Aleksandar Aleksiev"
                  class="cast-img"
                />
              </a>
              <span class="cast-title">Aleksandar Aleksiev</span>
            </div>
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/586060-yavor-baharov"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/9rYgdfaJSQ4Npbp0ZgpfalkSG70.jpg "
                  alt="Yavor Baharov"
                  class="cast-img"
                />
              </a>
              <span class="cast-title">Yavor Baharov</span>
            </div>
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/40672-mary-stockley"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/dpdFhBJcw41P5XSoGqp9ElPJHKO.jpg "
                  alt="Mary Stockley"
                  class="cast-img"
                />
              </a>
              <span class="cast-title">Mary Stockley</span>
            </div>
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/73401-michael-dixon"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/zDxnPEgYE2CC777IjZ8oW6yWlVl.jpg "
                  alt="Michael Dixon"
                  class="cast-img"
                />
              </a>
              <span class="cast-title">Michael Dixon</span>
            </div>
          </div>
        </div>
        <!-- Download -->
        <div class="download">
          ...
          <div class="download-links">
            <a
              href="https://streamtape.com/v/0RlXra88J8fb17b/I_Spit_on_Your_Grave_2_%282013%29_BluRay_720p_%28fzmovies.net%29_ae14b20eb88506cba4bdd01f717f57c1.mkv.mp4#"
              target="_blank"
              download
              >480p</a
            >
        ...
        <div class="swiper mySwiper">
          <div class="swiper-wrapper">
            <div class="swiper-slide">
              ...
              <div class="box-text">
                <a
                  href="../movieplay/It_Follows.html"
