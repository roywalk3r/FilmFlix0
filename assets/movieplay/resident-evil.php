...
<html lang="en-US">
  <head>
    ...
    <link
      rel="canonical"
      href="https://rseann.helioho.st/assets/movieplay/resident-evil.html"
    />
    <title>Watch: Resident Evil Welcome To Racoon City</title>
    ...
    <div class="section-container body-container">
      <div class="main-left">
        <div class="movie-play">
          <img
            src="https://www.themoviedb.org/t/p/original/97zkSinJ0i9ZY7p8VEFzLvGQPAq.jpg "
            alt="thumbnail"
            id="thumbnail"
          />
          <iframe
            src="https://vidsrc.to/embed/movie/460458"
            allowfullscreen
            allowtransparency
            allow="autoplay"
            scrolling="no"
        ...
        <div class="about-movie container">
          <div class="sypnosis">
            ...
            <div class="content">
              ...
              <div class="req">
                <span><i class="bx bx-calendar-alt"></i> 2021</span>
              ...
              <p>
                ...
                Corporation, Raccoon City is now a dying Midwestern town. The
                company’s exodus left the city a wasteland…with great evil
                brewing below the surface. When that evil is unleashed, the
                townspeople are forever…changed…and a small group of survivors
                must work together to uncover the truth behind Umbrella and make
                it through the night.
              </p>
              <span id="release"
                ><i class="fa fa-calendar"></i> Release date : 24<sup>th</sup>
                November 2021</span
              >
              <span id="writer"
                >Writer <span id="name">: Johannes Roberts</span></span
              >
          ...
          <div class="cast">
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/115150-kaya-scodelario"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src=" https://www.themoviedb.org/t/p/w300_and_h450_bestv2/uVp7VarM5GX08hfCEGt63OM5c5c.jpg"
                  alt="Kaya Scodelario"
                  class="cast-img"
                />
              </a>
            ...
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/1408809-hannah-john-kamen"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/V8P9EVelewGVXbuyEylqrzF6iG.jpg"
                  alt="Hannah John-Kamen"
                  class="cast-img"
                />
              </a>
              <span class="cast-title">Hannah John-Kamen</span>
            </div>
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/1223726-robbie-amell"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/qRDwwBVJmYk7yhlo8VwRMook4yd.jpg "
                  alt="Robbie Amell"
                  class="cast-img"
                />
              </a>
              <span class="cast-title">Robbie Amell</span>
            </div>
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/1017294-tom-hopper"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src=" https://www.themoviedb.org/t/p/w300_and_h450_bestv2/qS8F31xn6ZoNBTOvcXZfWewgma2.jpg"
                  alt="Tom Hopper"
                  class="cast-img"
                />
              </a>
              <span class="cast-title">Tom Hopper</span>
            </div>
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/212934-avan-jogia"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/7BX0Lg39bHlgtvWZpszTr1YjTAW.jpg "
                  alt="Avan Jogia"
                  class="cast-img"
                />
              </a>
              <span class="cast-title">Avan Jogia</span>
            </div>
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/10825-donal-logue"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/5Rj850yVkIqsgCihtZLbkNSHbFb.jpg "
                  alt="Donal Logue"
                  class="cast-img"
                />
              </a>
              <span class="cast-title">Donal Logue</span>
            </div>
          </div>
        </div>
        <!-- Download -->
        <div class="download">
          ...
          <div class="download-links">
            <a
              href=" https://streamtape.com/v/bpA0qkxLVMSP1bj/Resident_Evil_Welcome_to_Raccoon_City.mp4#
"
              target="_blank"
              download
              >480p</a
...
"
    ...
    <script src="https://www.google.com/recaptcha/api.js" async defer></script>    <script src="../js/login.js"></script>
