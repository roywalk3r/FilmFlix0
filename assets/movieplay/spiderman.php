...
<html lang="en-US">
  <head>
    ...
    <link
      rel="canonical"
      href="https://rseann.helioho.st/assets/movieplay/spiderman.html"
    />
    <title>Watch: Spiderman No Way Home (2021)</title>
    <!-- Local Links -->
    ...
    <div class="section-container body-container">
      <div class="main-left">
        <div class="movie-play">
          <img src="../img/spiderman.jpg" alt="thumbnail" id="thumbnail" />
          <iframe
            src="https://vidsrc.to/embed/movie/634649"
            allowfullscreen
            allowtransparency
            allow="autoplay"
            scrolling="no"
        ...
        <div class="about-movie container">
          <div class="sypnosis">
            <img
              src="../img/Spiderman-noWayHome.png"
              alt="movie poster"
              class="img"
            />
            <div class="content">
          ...
          <div class="cast">
            <div class="cast-box">
              <img src="../play-page/cast12.jpg" alt="" class="cast-img" />
              <span class="cast-title">Jacob Batalon</span>
            </div>
            <div class="cast-box">
            ...
            <div class="cast-box">
              <img src="../play-page/cast8..jpg" alt="" class="cast-img" />
              <span class="cast-title">Zendaya</span>
            </div>
            <div class="cast-box">
              <img src="../play-page/cast9.jpg" alt="" class="cast-img" />
              <span class="cast-title">Benedict Cumberbatch</span>
            </div>
            <div class="cast-box">
              <img src="../play-page/cast10.jpg" alt="" class="cast-img" />
              <span class="cast-title">Willem Dafoe</span>
            </div>
            <div class="cast-box">
              <img src="../play-page/cast11.jpg" alt="" class="cast-img" />
        ...
        <div class="download">
          ...
          <div class="download-links">
            <a
              href="https://streamtape.com/v/xZvGAx1LRZfvXr/Spider_Man_No_Way_Home_%282021%29_BluRay_720p_%28fzmovies.net%29_e8cbbbfbdf4346777d42100ad83d8a00.mkv.mp4#"
              target="_blank"
              download
              >480p</a
            >
