...
<html lang="en-US">
  <head>
    ...
    <link
      rel="canonical"
      href="https://rseann.helioho.st/assets/movieplay/Spectre.html"
    />
    <title>Watch: Spectre (2015)</title>
    <!-- Local Links -->
    ...
    <div class="section-container body-container">
      <div class="main-left">
        <div class="movie-play">
          <img
            src="https://www.themoviedb.org/t/p/original/tcf8WL3Lf1nWkOOT7SdhbS2kU6E.jpg"
            alt="thumbnail"
            id="thumbnail"
          />
          <iframe
            src="https://vidsrc.to/embed/movie/206647"
            allowfullscreen
            allowtransparency
            allow="autoplay"
            scrolling="no"
        ...
        <div class="about-movie container">
          <div class="sypnosis">
            <img src="../img/specter.jpg" alt="movie poster" class="img" />
            <div class="content">
              <h2>Spectre</h2>
              <div class="req">
                <span><i class="bx bx-calendar-alt"></i> 2015</span>
                <span class="age-req"><i>PG 13</i></span>
                <span><i class="bx bx-time"></i> 2h 28min</span>
              </div>
              <p>
          ...
          <div class="cast">
            <div class="cast-box">
              <img
                src="https://upload.wikimedia.org/wikipedia/commons/thumb/8/87/Daniel_Craig_in_2021.jpg/800px-Daniel_Craig_in_2021.jpg"
                alt="Daniel Craig"
                class="cast-img"
              />
              <span class="cast-title">Daniel Craig</span>
            </div>
            <div class="cast-box">
              <img
                src="https://upload.wikimedia.org/wikipedia/commons/thumb/d/d8/Christoph_Waltz_Viennale_2017_f_%28cropped%29.jpg/220px-Christoph_Waltz_Viennale_2017_f_%28cropped%29.jpg"
                alt="-Christoph_Waltz_Viennale"
                class="cast-img"
              />
              <span class="cast-title">Christoph Waltz</span>
            </div>
            <div class="cast-box">
              <img
                src="https://upload.wikimedia.org/wikipedia/commons/6/6d/L%C3%A9a_Seydoux_Cannes_2016.jpg"
                alt="Lea Seydoux"
                class="cast-img"
              />
              <span class="cast-title">Lea Seydoux</span>
            </div>
            <div class="cast-box">
              <img
                src="../play-page/Jack-Whiteha.jpg"
                alt=""
                class="cast-img"
              />
            ...
            <div class="cast-box">
              <img src="../play-page/Jesse.jpg" alt="" class="cast-img" />
              <span class="cast-title">Jesse Plemons</span>
            </div>
            <div class="cast-box">
              <img
                src="../play-page/Veronica-Falcon.jpg"
                alt=""
                class="cast-img"
              />
              <span class="cast-title">Veronica Falcon</span>
            </div>
          </div>
        </div>
        <!-- Download -->
        <div class="download">
          ...
          <div class="download-links">
            <a
              href="https://streamtape.com/v/KQrp4Yb4pyszJr/Spectre_%282015%29_BluRay_720p_%28fzmovies.net%29_0ebac009762cb7ab5f4aff79a411daf3.mkv#"
              target="_blank"
              download
              >720p</a
            >
