...
<html lang="en-US">
  <head>
    ...
    <link
      rel="canonical"
      href="https://rseann.helioho.st/assets/movieplay/Wakanda.html"
    />
    ...
    <div class="section-container body-container">
      <div class="main-left">
        <div class="movie-play">
          <img
            src="../img/Black_Panther_Wakanda_Forever_poster.jpeg"
            alt="thumbnail"
            id="thumbnail"
          />
          <iframe
            src="https://vidsrc.to/embed/movie/505642"
            allowfullscreen
            allowtransparency
            allow="autoplay"
            scrolling="no"
        ...
        <div class="about-movie container">
          <div class="sypnosis">
            <img
              src="../img/Black_Panther_Wakanda_Forever_poster.jpg"
              alt="movie poster"
              class="img"
            />
            <div class="content">
              ...
              <div class="req">
                <span><i class="bx bx-calendar-alt"></i> 2022</span>
                <span class="age-req"><i>PG 13</i></span>
                <span><i class="bx bx-time"></i> 2h 42min</span>
              </div>
              <p>
              ...
              <span id="release"
                ><i class="fa fa-calendar"></i> Release date : 29<sup>th</sup>
                July 2022</span
              >
              <span id="writer"
          ...
          <div class="cast">
            <div class="cast-box">
              <img
                src="../play-page/letitia-Wright.jpg"
                alt=""
                class="cast-img"
              />
              <span class="cast-title">Letitia Wright</span>
            </div>
            <div class="cast-box">
              <img
                src="../play-page/Lupita-Nyog'o.jpg"
                alt=""
                class="cast-img"
              />
              <span class="cast-title">Lupita Nyog'o</span>
            </div>
            <div class="cast-box">
              <img
                src="../play-page/Danai_Gurira.jpg"
                alt=""
                class="cast-img"
              />
              <span class="cast-title">Danai Gurira</span>
            </div>
            <div class="cast-box">
              <img
                src="../play-page/Winston-Duke.jpg"
                alt=""
                class="cast-img"
              />
              <span class="cast-title">Winston Duke</span>
            </div>
            <div class="cast-box">
              <img
                src="../play-page/FLorence-Kasumba.jpg"
                alt=""
                class="cast-img"
              />
              <span class="cast-title">Florence kasumba</span>
            </div>
            <div class="cast-box">
              <img
                src="../play-page/Michaela-Coela.jpg"
                alt=""
                class="cast-img"
              />
              <span class="cast-title">Michaela Coela</span>
            </div>
          </div>
        </div>
        <!-- Download -->
        <div class="download">
          ...
          <div class="download-links">
            <a
              href="https://streamtape.com/v/GJqKVR0GXPFoVa/Black_Panther_Wakanda_Forever_%282022%29_%28NetNaija.com%29.mkv.mp4#"
              target="_blank"
              download
              >480p</a
            >
