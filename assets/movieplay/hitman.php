...
<html lang="en-US">
  <head>
    ...
    <link
      rel="canonical"
      href="https://rseann.helioho.st/assets/movieplay/hitman.html"
    />
    <title>Watch: Hitman Bodyguard (2017)</title>
    <!-- Local Links -->
    ...
    <div class="section-container body-container">
      <div class="main-left">
        <div class="movie-play">
          <img
            src="../img/the-hitmans-bodyguard-banner.webp "
            alt="thumbnail"
            id="thumbnail"
          />
          <iframe
            src="https://vidsrc.to/embed/movie/390043"
            allowfullscreen
            allowtransparency
            allow="autoplay"
            scrolling="no"
        ...
        <div class="about-movie container">
          <div class="sypnosis">
            <img
              src="../img/HitmansBodyguard.jpg"
              alt="movie poster"
              class="img"
            />
            <div class="content">
              <h2>Hitman's Bodyguard</h2>
              <div class="req">
                <span><i class="bx bx-calendar-alt"></i> 2023</span>
                <span class="age-req"><i>PG 13</i></span>
                <span><i class="bx bx-time"></i> 1h 58min</span>
              </div>
              <p>
                Michael Bryce lives a luxurious life as a successful UK-based
                private bodyguard, until his client Takashi Kurosawa, an
                international arms dealer, is assassinated on his watch. Two
                years later, the fallen-from-grace Bryce survives by protecting
                drug-addicted corporate executives in London.
              </p>
              <span id="release"
              ...
              >
              <span id="writer"
                >Writer <span id="name"> : Tom O'Connor</span></span
              >
          ...
          <div class="cast">
            <div class="cast-box">
              ...
              <span class="cast-title">Ryan Renolds</span>
            </div>
            <div class="cast-box">
              <img src="../play-page/salma.jpg" alt="" class="cast-img" />
              <span class="cast-title">Salma Hayek</span>
            </div>
            <div class="cast-box">
              <img src="../play-page/samuel.jpg" alt="" class="cast-img" />
        ...
        <div class="download">
          ...
          <div class="download-links">
            <a
              href="
https://streamtape.com/v/9pWaoGA727CYeW/The_Hitmans_Bodyguard_2017_%282017%29_BluRay_720p_%28fzmovies.net%29_a84c46d46b99a89334612009615493be.mkv.mp4#"
              target="_blank"
              download
              >480p</a
            >
