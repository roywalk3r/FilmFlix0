...
<html lang="en-US">
  <head>
    ...
    <link
      rel="canonical"
      href="https://rseann.helioho.st/assets/movieplay/Halloween.html"
    />
    <title>Watch: Halloween(2018)</title>
    <!-- Local Links -->
    ...
    <div class="section-container body-container">
      <div class="main-left">
        <div class="movie-play">
          <img
            src="https://c4.wallpaperflare.com/wallpaper/24/979/826/movie-halloween-2007-wallpaper-preview.jpg "
            alt="thumbnail"
            id="thumbnail"
          />
          <iframe
            src="https://vidsrc.to/embed/movie/tt1502407"
            allowfullscreen
            allowtransparency
            allow="autoplay"
            scrolling="no"
        ...
        <div class="about-movie container">
          <div class="sypnosis">
            <img src="../img/halloween.jpg" alt="movie poster" class="img" />
            <div class="content">
              <h2>Halloween</h2>
              <div class="req">
                <span><i class="bx bx-calendar-alt"></i> 2018</span>
                <span class="age-req"><i>PG 13</i></span>
                <span><i class="bx bx-time"></i> 1h 50min</span>
              </div>
              <p>
                After being committed for 17 years, Michael Myers, now a grown
                man and still very dangerous, escapes from the mental
                institution (where he was committed as a 10 year old) and he
                immediately returns to Haddonfield, where he wants to find his
                baby sister, Laurie. Anyone who crosses his path is in mortal
                danger.
              </p>
              <span id="release"
                ><i class="fa fa-calendar"></i> Release date : 31<sup>st</sup>
                August 2018</span
              >
              <span id="writer"
                >Writer <span id="name">: Rob Zombie</span></span
              >
              <div class="rating-card">
                <div class="rating-content">
                  <h2 class="card-heading">6.81/10</h2>
          ...
          <div class="cast">
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/21318-scout-taylor-compton"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/qQX8q1igfh6cIKyd7vjIPu1QUmr.jpg"
                  alt="Scout Taylor-Compton"
                  class="cast-img"
                />
              </a>
              <span class="cast-title">Scout Taylor-Compton</span>
            </div>
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/9832-tyler-mane"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src=" https://www.themoviedb.org/t/p/w300_and_h450_bestv2/h5knoBWStVv7a0FKPwfKV7f7Ez1.jpg"
                  alt="Tyler Mane"
                  class="cast-img"
                />
              </a>
              <span class="cast-title">Tyler Mane</span>
            </div>
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/56890-malcolm-mcdowell"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/hL8ep4Hqj6izX7IlzE7Bbcfq62w.jpg"
                  alt="Malcolm McDowell"
                  class="cast-img"
                />
              </a>
              <span class="cast-title">Malcolm McDowell</span>
            </div>
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/21317-daeg-faerch"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/hXO449dEfMEJi8HOciQIKIqAmQr.jpg"
                  alt="Daeg Faerch"
                  class="cast-img"
                />
              </a>
              <span class="cast-title">Daeg Faerch</span>
            </div>
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/21319-sheri-moon-zombie"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/jJwAiJps5cOz484c3QJgjKe1yxJ.jpg "
                  alt="Sheri Moon Zombie"
                  class="cast-img"
                />
              </a>
              <span class="cast-title">Sheri Moon Zombie</span>
            </div>
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/21320-danielle-harris"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/5REXVo1Q3xA9bMjpHmWM3v5lSiZ.jpg"
                  alt="Danielle Harris"
                  class="cast-img"
                />
              </a>
              <span class="cast-title">Danielle Harris</span>
            </div>
          </div>
        </div>
        <!-- Download -->
        <div class="download">
          ...
          <div class="download-links">
            <a
              href="https://streamtape.com/v/8DKq948JoZCoo1b/Halloween_%282007%29_BluRay_720p_%28fzmovies.net%29_19f63b44bbead50e7d66011f82652dcb.mkv.mp4#"
              target="_blank"
              download
              >480p</a
            >
            ...
            <div class="movie">
              ...
              <div class="movie-container">
                ...
                <span class="bottom-content">
                  <p>Movie</p>
                  <p>1 Eps</p>
                  <p class="fas fa-bookmark">&nbsp;677k</p>
                </span>
              </div>
            </div>
          </a>
          <a href="It_Follows.html">
            <div class="movie">
              <img src="../img/it-follows.jpg" alt="" />
              <div class="movie-container">
                <small>Horror</small>
                <h4>It Follows</h4>
                <span class="bottom-content">
