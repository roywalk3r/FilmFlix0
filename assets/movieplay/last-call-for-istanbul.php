...
<head>
  ...
  <title>Watch: Last Call for Istanbul</title>
  <!-- Local Links -->
  ...
  <div class="section-container body-container">
    <div class="main-left">
      <div class="movie-play">
        <img src="https://www.themoviedb.org/t/p/original/wEwE7WtkoQSW7ZmlRI8fRz3C0LQ.jpg" alt="thumbnail" id="thumbnail" />
        <iframe src="https://vidsrc.to/embed/movie/1044302" allowfullscreen allowtransparency allow="autoplay" scrolling="no" frameborder="0" id="video-iframe"></iframe>
        <i class="fa-solid fa-play play-movie-btn" style="color: #ffffff" id="play-button"></i>
      </div>
      <!-- About  -->
      <div class="about-movie body-container">
        <div class="sypnosis">
          <img src="../.././posters/instabul.jpg" alt="" class="img" />
          <div class="content">
            <h2>Last Call for Istanbul</h2>
            ...
            <span id="release"><i class="fa fa-calendar"></i> Release date :2023-11-24</span>
            <span id="writer">Writer <span id="name">: Nuran Evren Şit </span></span>
        ...
        <div class="cast">
          <div class="cast-box"><a target="_blank" title="Read about actor on MovieDB"><img src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/shY75ZsxGshq1BFh0dl1og9dd73.jpg" alt="Beren Saat" class="cast-img" /></a><span class="cast-title">Beren Saat</span></div>
          <div class="cast-box"><a target="_blank" title="Read about actor on MovieDB"><img src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/8k8PAjTvK8UlgUAHq95HMYYOIG6.jpg" alt="Kıvanç Tatlıtuğ" class="cast-img" /></a><span class="cast-title">Kıvanç Tatlıtuğ</span></div>
          <div class="cast-box"><a target="_blank" title="Read about actor on MovieDB"><img src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/1W2OYG58iTe1UfZRhjcTLXZYo6q.jpg" alt="Senan Kara" class="cast-img" /></a><span class="cast-title">Senan Kara</span></div>
          <div class="cast-box"><a target="_blank" title="Read about actor on MovieDB"><img src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/tq4mf826Sfnjg5kIQm5nJUA61l7.jpg" alt="Zihan Zhao" class="cast-img" /></a><span class="cast-title">Zihan Zhao</span></div>
          <div class="cast-box"><a target="_blank" title="Read about actor on MovieDB"><img src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/yd0sldIyVn3Yt2SaRN4CQkowgxz.jpg" alt="Michael Loayza" class="cast-img" /></a><span class="cast-title">Michael Loayza</span></div>
          <div class="cast-box"><a target="_blank" title="Read about actor on MovieDB"><img src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/lOgrPqkTSs0KwSySMC44zy01XGH.jpg" alt="Susan Slatin" class="cast-img" /></a><span class="cast-title">Susan Slatin</span></div>
        </div>
        ...
        <a href="oppenheimer-.php">
          <div class="movie">
            ...
            <div class="movie-container">
              <small>similar</small>
              <h4>Mission: Impossible - Dead Reck...</h4>
