...
<html lang="en-US">
  <head>
    ...
    <link
      rel="canonical"
      href="https://rseann.helioho.st/assets/movieplay/horriblebosses1.html"
    />
    <title>Watch: Horrible Bosses (2011)</title>
    ...
    <div class="section-container body-container">
      <div class="main-left">
        <div class="movie-play">
          <img
            src="https://wallpapercave.com/wp/wp10029349.jpg"
            alt="thumbnail"
            id="thumbnail"
          />
          <iframe
            src="https://vidsrc.to/embed/movie/51540"
            allowfullscreen
            allowtransparency
            allow="autoplay"
            scrolling="no"
        ...
        <div class="about-movie container">
          <div class="sypnosis">
            <img
              src="../img/horriblebosses1.jpg"
              alt="movie poster"
              class="img"
            />
            <div class="content">
              <h2>Horibble Bosses</h2>
              <div class="req">
                <span><i class="bx bx-calendar-alt"></i> 2014</span>
                <span class="age-req"><i>PG 13</i></span>
                <span><i class="bx bx-time"></i> 1h 38min</span>
              </div>
              <p>
                For Nick, Kurt and Dale, the only thing that would make the
                daily grind more tolerable would be to grind their intolerable
                bosses into dust. Quitting is not an option, so, with the
                benefit of a few-too-many drinks and some dubious advice from a
                hustling ex-con, the three friends devise a convoluted and
                seemingly foolproof plan to rid themselves of their respective
              ...
              >
              <span id="writer"
                >Writer <span id="name">: John Francis Daley</span></span
              >
              <div class="rating-card">
                <div class="rating-content">
                  <h2 class="card-heading">7.81/10</h2>
                  <span style="color: rgb(86, 39, 129)">5314 reviews</span>
                </div>
                <div class="stars">
          ...
          <div class="cast">
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/23532-jason-bateman?language=en-US"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/8e6mt0vGjPo6eW52gqRuXy5YnfN.jpg"
                  alt="Jason Bateman"
                  class="cast-img"
                />
              </a>
              <span class="cast-title">Jason Bateman</span>
            </div>
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/58224-jason-sudeikis?language=en-US"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/uuacnP9DOHMsmj8FhBi0cWWDgrn.jpg "
                  alt="Jason Sudeikis"
                  class="cast-img"
                />
              </a>
              <span class="cast-title">Jason Sudeikis</span>
            </div>
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/95101-charlie-day?language=en-US"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/c0HNhjChGybnHa4eoLyqO4dDu1j.jpg "
                  alt="Charlie Day"
                  class="cast-img"
                />
              </a>
            ...
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/4491-jennifer-aniston?language=en-US"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/qPXG41rYdUGldZhMhuZFvmpZKRp.jpg"
                  alt="Jennifer Aniston"
                  class="cast-img"
                />
              </a>
              <span class="cast-title">Jennifer Aniston</span>
            </div>
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/1979-kevin-spacey?language=en-US"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/dlVRkUYKyZdJ39AN55cY1LoyXAP.jpg "
                  alt="Kevin Spacey"
                  class="cast-img"
                />
              </a>
              <span class="cast-title">Kevin Spacey</span>
            </div>
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/134-jamie-foxx?language=en-US"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/zD8Nsy4Xrghp7WunwpCj5JKBPeU.jpg "
                  alt="Jamie Foxx"
                  class="cast-img"
                />
              </a>
              <span class="cast-title">Jamie Foxx</span>
            </div>
          </div>
        </div>
        ...
        <div class="download">
          ...
          <div class="download-links">
            <a
              href="https://streamtape.com/v/r082RYLw7gTb0ZW/Horrible_Bosses_2_%282014%29_BluRayExt_720p.mkv.mp4#"
              target="_blank"
              download
              >480p</a
            >
      ...
      <div class="right-sidebar">
        ...
        <div class="related-movies">
          <a href="horriblebosses.html">
            <div class="movie">
              <img src="../img/horriblebosses.jpg" alt="" />
              <div class="movie-container">
                <small>Comedy</small>
                <h4>Horribble Bosses 2</h4>
          ...
          <a href="mall_cop2.html">
            <div class="movie">
              <img src="../img/mall_cop.jpg" alt="" />
              <div class="movie-container">
                <small>Comedy</small>
                <h4>Mall Cop 2</h4>
                <span class="bottom-content">
        ...
        <div class="swiper mySwiper">
          <div class="swiper-wrapper">
            <div class="swiper-slide">
              ...
              <div class="box-text">
                <a
                  href="../movieplay/horriblebosses.html"
            ...
            <div class="swiper-slide">
              ...
              <div class="box-text">
                <a href="../movieplay/hitman2.html" class="watch-btn play-btn">
                  <i class="bx bx-right-arrow"></i>
                </a>
              </div>
            </div>
