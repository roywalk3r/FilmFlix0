...
<html lang="en-US">
  <head>
    ...
    />
    <title>Watch: The Punisher (2004)</title>
    <!-- Local Links -->
    ...
    <div class="section-container body-container">
      <div class="main-left">
        <div class="movie-play">
          <img
            src="https://www.themoviedb.org/t/p/original/9j9qKlz9GvmSD3np6UEwWe6uSb.jpg"
            alt="thumbnail"
            id="thumbnail"
          />
          <iframe
            src="https://vidsrc.to/embed/movie/7220"
            allowfullscreen
            allowtransparency
            allow="autoplay"
            scrolling="no"
        ...
        <div class="about-movie container">
          <div class="sypnosis">
            <img src="../img/the_punisher.jpg" alt="movie poster" class="img" />
            <div class="content">
              <h2>The Punisher</h2>
              <div class="req">
                <span><i class="bx bx-calendar-alt"></i> 2004</span>
                <span class="age-req"><i>PG 13</i></span>
                <span><i class="bx bx-time"></i> 1h 44min</span>
              </div>
              <p>
                When undercover FBI agent Frank Castle's wife and son are
                slaughtered, he becomes 'the Punisher' -- a ruthless vigilante
                willing to go to any length to avenge his family.
              </p>
              <span id="release"
              ...
              >
              <span id="writer"
                >Writer <span id="name">: Michael France</span></span
              >
          ...
          <div class="cast">
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/11155-thomas-jane"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/kytPt3B4ft2DH7OMNiAsWuXkw4K.jpg "
                  alt="Thomas Jane"
                  class="cast-img"
                />
              </a>
              <span class="cast-title">Thomas Jane</span>
            </div>
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/8891-john-travolta"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src=" https://www.themoviedb.org/t/p/w300_and_h450_bestv2/9axs7CGk01nmGqBAppDR92JHucn.jpg"
                  alt="John Travolta"
                  class="cast-img"
                />
              </a>
              <span class="cast-title">John Travolta</span>
            </div>
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/883-will-patton"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/1V4DbU1mfEim4oaA5bvJywDAKwB.jpg "
                  alt="Will Patton"
                  class="cast-img"
                />
              </a>
              <span class="cast-title">Will Patton</span>
            </div>
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/6355-roy-scheider"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/yyZ0DwUz3qAelJIUGVoOktGgMIh.jpg "
                  alt="Roy Scheider"
                  class="cast-img"
                />
              </a>
              <span class="cast-title">Roy Scheider</span>
            </div>
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/15007-laura-harring"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src=" https://www.themoviedb.org/t/p/w300_and_h450_bestv2/6g64N2VsADTPRDsKcJDO2ayGQUt.jpg"
                  alt="Laura Harring"
                  class="cast-img"
                />
              </a>
              <span class="cast-title">Laura Harring</span>
            </div>
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/11107-ben-foster"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/4le1PMWTGp7y2IBmZEIOHfE3HAB.jpg "
                  alt="Ben Foster"
                  class="cast-img"
                />
              </a>
              <span class="cast-title">Ben Foster</span>
            </div>
          </div>
        </div>
        <!-- Download -->
        <div class="download">
          ...
          <div class="download-links">
            <a
              href="https://streamtape.com/v/pr2M6jDbdahroov/The_Punisher_2004_%282004%29_BluRay_720p_%28fzmovies.net%29_7bee6062ecde7f04b01d5788a254dd2d.mkv.mp4#"
              target="_blank"
              download
              >480p</a
            >
