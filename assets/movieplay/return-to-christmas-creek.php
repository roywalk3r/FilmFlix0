    ...
    <div class="section-container body-container">
      <div class="main-left">
        <div class="movie-play">
          <img
            src="https://www.themoviedb.org/t/p/w533_and_h300_bestv2/zNUmOf9vOk0f146jQBrBkdmrZyH.jpg"
            alt="thumbnail"
            id="thumbnail"
          />
          <iframe
            src="https://vidsrc.to/embed/movie/tt9103028"
            allowfullscreen
            allowtransparency
            allow="autoplay"
            scrolling="no"
        ...
        <div class="about-movie body-container">
          <div class="sypnosis">
            <img
              src="../img/return-to-christmas-creek.jpg"
              alt=""
              class="img"
            />
            <div class="content">
              <h2>Return to Christmas Creek</h2>
              <div class="req">
              ...
              <p>
                As Christmas approaches, Amelia Hughes, a career-focused Chicago
                app developer lacking in holiday spirit, returns to her small
                hometown of Christmas Creek to rediscover the meaning of
                Christmas. There, she reunites with her childhood best friend
                Mike and her estranged uncle Harry, whose mysterious rift with
                Amelia’s father divided her family during the holiday season
              ...
              >
              <span id="writer"
                >Writer <span id="name">: J.B. White </span></span
              >
          ...
          <div class="cast">
            ...
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/1339147-tori-anderson?language=en-US"
                target="_blank"
                title="read about actor on MovieDB"
              >
                <img
                  src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/4s3YDyecXglwsBupl9fiK6WOGGS.jpg"
                  alt="Tori Anderson"
                  class="cast-img"
                />
              </a>
              <span class="cast-title">Tori Anderson</span>
            </div>
            <div class="cast-box">
              <a
          ...
          <div class="download">
            ...
            <div class="download-links">
              <a
                href="    https://streamtape.com/v/JXJPGjMXrYTj839/A_Royal_Christmas_Crush_2023.mp4#"
                target="_blank"
                download
                >480p</a
              >
      ...
      <div class="right-sidebar">
        ...
        <div class="related-movies">
          <a href="a-royal-christmas-crush.html">
            <div class="movie">
              <img src="../img/crush-christmas.jpg" alt="" />
              <div class="movie-container">
                <small>similar</small>
                <h4>Royal Christmas</h4>
                <span class="bottom-content">
                  <p>Movie</p>
                  <p>1 Eps</p>
                  <p class="fas fa-bookmark">&nbsp;47k</p>
                </span>
              </div>
            </div>
          </a>
