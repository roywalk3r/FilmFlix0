...
<html lang="en-US">
  <head>
    ...
    <link
      rel="canonical"
      href="https://rseann.helioho.st/assets/movieplay/horriblebosses.html"
    />
    <title>Watch: Horrible Bosses 2 (2014)</title>
    ...
    <div class="section-container body-container">
      <div class="main-left">
        <div class="movie-play">
          <img
            src="../img/horriblebosses2-bg.jpg"
            alt="thumbnail"
            id="thumbnail"
          />
          <iframe
            src="https://vidsrc.to/embed/movie/227159"
            allowfullscreen
            allowtransparency
            allow="autoplay"
            scrolling="no"
        ...
        <div class="about-movie container">
          <div class="sypnosis">
            <img
              src="../img/horriblebosses.jpg"
              alt="movie poster"
              class="img"
            />
            <div class="content">
              <h2>Horibble Bosses 2</h2>
              <div class="req">
              ...
              <span id="release"
                ><i class="fa fa-calendar"></i> Release date : 26<sup>th</sup>
                November 2014</span
              >
              <span id="writer"
                >Writer <span id="name">: John Morris</span></span
              >
      ...
      <div class="right-sidebar">
        ...
        <div class="related-movies">
          <a href="horriblebosses1.html">
            <div class="movie">
              <img src="../img/horriblebosses1.jpg" alt="" />
              <div class="movie-container">
                <small>Comedy</small>
                <h4>Horribble Bosses 1</h4>
