...
<html lang="en-US">
  <head>
    ...
    <link
      rel="canonical"
      href="https://rseann.helioho.st/assets/movieplay/quite-place.html"
    />
    ...
    <div class="section-container body-container">
      <div class="main-left">
        <div class="movie-play">
          <img
            src="https://m.media-amazon.com/images/S/pv-target-images/387fc065653b38e3d718acd7719b7f6db07fb78b9997d6d40cb9e94b2acb7c4b._UR1920,1080_.jpg"
            alt="thumbnail"
            id="thumbnail"
          />
          <iframe
            src="https://vidsrc.to/embed/movie/tt6644200"
            allowfullscreen
            allowtransparency
            allow="autoplay"
            scrolling="no"
        ...
        <div class="about-movie container">
          <div class="sypnosis">
            <img src="../img/quiteplace.jpg" alt="movie poster" class="img" />
            <div class="content">
              <h2>A Quite Place</h2>
              <div class="req">
              ...
              <p>
                A Quiet Place is a post-apocalyptic horror film where a family
                is forced to live in silence while hiding from monsters with
                ultra-sensitive hearing. They must now rely on each other to
                survive.
              </p>
              <span id="release"
                ><i class="fa fa-calendar"></i> Release date : 3<sup>rd</sup>
                April 2018</span
              >
              <span id="writer"
          ...
          <div class="cast">
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/5081-emily-blunt"
                target="_blank"
                title="Read about Emily Blunt on MovieDB"
              >
                <img
                  src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/2mfJILwVGr4RBha3OihQVfq5nyL.jpg"
                  alt="Emily Blunt"
                  class="cast-img"
                />
            ...
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/17697-john-krasinski"
                target="_blank"
                title="Read about John Krasinski on MovieDB"
              >
                <img
                  src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/kFAUNOlV25OjZGm2vYnvxc6rSUK.jpg"
                  alt="John Krasinski"
                  class="cast-img"
                />
                <span class="cast-title">John Krasinski</span>
              </a>
            </div>
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/1815539-millicent-simmonds"
                target="_blank"
                title="Read about Millicent Simmonds on MovieDB"
              >
                <img
                  src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/3iDxFc3e2PExQgP9zxDUzXOwzrW.jpg"
                  alt="Millicent Simmonds"
                  class="cast-img"
                />
                <span class="cast-title">Millicent Simmonds</span>
              </a>
            </div>
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/1590759-noah-jupe"
                target="_blank"
                title="Read about Noah Jupe on MovieDB"
              >
                <img
                  src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/bXe9Z7QHCx7wksNX9Qg9bm4kDAr.jpg"
                  alt="Noah Jupe"
                  class="cast-img"
                />
                <span class="cast-title">Noah Jupe</span>
              </a>
            </div>
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/1924769-cade-woodward"
                target="_blank"
                title="Read about Cade Woodward on MovieDB"
              >
                <img
                  src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/6tXfrNe9ilHeAby6Eg5tNvq5MGY.jpg"
                  alt="Cade Woodward"
                  class="cast-img"
                />
                <span class="cast-title">Cade Woodward</span>
              </a>
            </div>
            <div class="cast-box">
              <a
                href="https://www.themoviedb.org/person/169920-leon-russom"
                target="_blank"
                title="Read about Leon Russom on MovieDB"
              >
                <img
                  src="https://www.themoviedb.org/t/p/w300_and_h450_bestv2/lLBJc5ThJEMafNUlsQyYQ7x1efg.jpg"
                  alt="Leon Russom"
                  class="cast-img"
                />
                <span class="cast-title">Leon Russom</span>
              </a>
            </div>
          </div>
        </div>
        ...
        <div class="download">
          ...
          <div class="download-links">
            <a
              href="https://streamtape.com/v/3r1yGGyVK7h29D/A_Quiet_Place_%282018%29_BluRay_v2_720p_%28fzmovies.net%29_930743b5ea185e5cadf5e580e2e94e28.mkv.mp4#"
              target="_blank"
              download
              >480p</a
            >
            ...
            <div class="movie">
              ...
              <div class="movie-container">
                ...
                <span class="bottom-content">
                  <p>Movie</p>
                  <p>1 Eps</p>
                  <p class="fas fa-bookmark">&nbsp;12k</p>
                </span>
              </div>
            </div>
          </a>
          <a href="punisher.html">
            <div class="movie">
              <img src="../img/the_punisher.jpg" alt="" />
              <div class="movie-container">
                <small>Action</small>
                <h4>The Punisher</h4>
                <span class="bottom-content">
